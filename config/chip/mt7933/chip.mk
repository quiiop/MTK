...
MTK_HIF_HEADER_2DW                          ?= n
MTK_CM4_N9_SINGLE_IMG                       ?= n
...
ALLFLAGS = -mlittle-endian -mthumb -mcpu=cortex-m33 -DARMCM33_DSP_FP_TZ
...
## Dependency:  N/A
##
ifeq ($(MTK_FPGA_ENABLE),y)
COM_CFLAGS         += -DMTK_FPGA_ENABLE
endif

## MTK_1ST_LINK_SRAM_BOOT
## Brief:  1st day link SRAM build
## Usage: Default off
## Path: project/mt7933_hdk/apps/qfn_evb/gcc/feature.mk
## Dependency:  N/A
##
ifeq ($(MTK_1ST_LINK_SRAM_BOOT),y)
COM_CFLAGS         += -DMTK_1ST_LINK_SRAM_BOOT
endif
...
## Dependency:  N/A
##
ifeq ($(MT7933_E2_ENABLE),y)
MTK_ROM_VER = e2
COM_CFLAGS         += -DMTK_ROM_VER=e2
COM_CFLAGS         += -DMT7933_E2_ENABLE
...
## Usage:  Need to enable in MT7933
...
##
## MTK_BOOT_CLI_ENABLE
## Brief:  Enable boot CLI commands.
## Usage:  If the value is "y", the MTK_BOOT_CLI_ENABLE compile option will be defined.
## Path:   N/A
## Dependency:  N/A
##
ifeq ($(MTK_BOOT_CLI_ENABLE),y)
COM_CFLAGS         += -DMTK_BOOT_CLI_ENABLE
endif
...
##
## MTK_LP_DVT_CLI_ENABLE
##
## Brief:       This option enables testing and under development features.
##              related CLI commands.
##
## Usage:       If the value is "y", the macro MTK_LP_DVT_CLI_ENABLE will
##              be defined. It's used for low power DVT test cli commands.
##              When product is going to mass production and the "DVT test commands"
##              are not supposed to be released, this test mode macro can be
##              turned off to remove them.
##
## Path:        driver/board/mt7933_hdk/util/inc/lp_dvt_cli.h
##
## Dependency:  MTK_MINICLI_ENABLE must also defined in feature.mk under
##              project inc folder.
##
## Related doc: See also in
##              driver/board/mt7933_hdk/util/inc/lp_dvt_cli.h for the list of
##              test commands.
##
ifeq ($(MTK_LP_DVT_CLI_ENABLE),y)
COM_CFLAGS         += -DMTK_LP_DVT_CLI_ENABLE
endif

ifeq ($(MTK_BSP_DVT_CLI_ENABLE),y)
COM_CFLAGS         += -DMTK_BSP_DVT_CLI_ENABLE
endif
...
## Usage:     If the value is "y", the MTK_SWLA_ENABLE compile option will be defined. You must also include the kernel\service\module.mk in your Makefile before setting the option to "y".
##            If the MTK_SWLA_USE_SYSRAM_BUFFER is enabled, the SWLA buffer is moved to SYSRAM. Otherwise, the SWLA buffer is placed in PSRAM.
##            If the MTK_SWLA_WDT_RESET_TRACE is enabled, the SWLA buffer will be output to UART after watch dog reset.
## Path:       kernel\service
## Dependency:  MTK_HAL_GPT_MODULE_ENABLE must be defined in the project.
## Notice:      None
## Relative doc:None
##
ifeq ($(MTK_SWLA_ENABLE),y)
CFLAGS += -DMTK_SWLA_ENABLE
ifeq ($(MTK_SWLA_USE_SYSRAM_BUFFER),y)
CFLAGS += -DMTK_SWLA_USE_SYSRAM_BUFFER
endif
ifeq ($(MTK_SWLA_WDT_RESET_TRACE),y)
CFLAGS += -DMTK_SWLA_WDT_RESET_TRACE
endif
endif
...
## Dependency:  Must enable MTK_FATFS_ENABLE, MTK_POSIX_SUPPORT_ENABLE, MTK_MT7933_AUDIO_DRIVER_ENABLE, MTK_MT7933_AUDIO_CODEC_ENABLE in the feature.mk under the project GCC folder..
...
##
## MTK_WIFI_SIGN_ENABLE
## Brief:       This option controls F/W signature of Wi-Fi F/W.
## Usage:       Enable the feature by configuring it as y.
## Path:        middleware/MTK/sboot
## Dependency:  mcuboot
## Notice:      None
...
ifeq ($(MTK_WIFI_SIGN_ENABLE),y)
  CFLAGS += -DMTK_WIFI_SIGN_ENABLE
endif


##
## MTK_BT_SIGN_ENABLE
## Brief:       This option controls F/W signature of BT/BLE F/W.
## Usage:       Enable the feature by configuring it as y.
## Path:        middleware/MTK/sboot
## Dependency:  mcuboot
## Notice:      None
...
ifeq ($(MTK_BT_SIGN_ENABLE),y)
  CFLAGS += -DMTK_BT_SIGN_ENABLE
endif


##
## MTK_DSP_SIGN_ENABLE
## Brief:       This option controls F/W signature of  ADSP F/W.
## Usage:       Enable the feature by configuring it as y.
## Path:        middleware/MTK/sboot
## Dependency:  mcuboot
## Notice:      None
...
## Usage:       Enable the feature by configuring it as y.
## Path:        project/mt7933_hdk/apps/iot_sdk_demo/src/sys_init.c, middleware/MTK/connsys/src/connsys_util.c
## Dependency:  None
## Notice:      None
## Relative doc:None
##
...
##
## MTK_NO_INIT_HEAP_ENABLE
## MTK_NO_INIT_HEAP_ENABLE is a option to select whether to clear heap area, if enable: it declare of ATTR_ZIDATA_IN_NON_INIT_SYSRAM/RAM
## (in sys_init.c) that no to clear heap area for reduce boot up time. if disable: it declare of ATTR_ZIDATA_IN_SYSRAM that will clear heap area.(in startup_mt7933.s)
##
ifeq ($(MTK_NON_INIT_HEAP),y)
COM_CFLAGS         += -DMTK_NON_INIT_HEAP
endif
...
##
## MTK_GCC_LTO_ENABLE
## Brief:       Enable the GCC link time optimization
## Usage:       Change MTK_GCC_LTO_ENABLE to 'y' in feature.mk
## Path: None.
## Dependency: None.
## Notice: None.
## Related doc: None.
##
ifeq ($(MTK_GCC_LTO_ENABLE),y)
COM_CFLAGS += -flto -ffat-lto-objects
COM_CFLAGS += -DMTK_GCC_LTO_ENABLE
# Switch prebuilt libraries to lto version
LTO_LIB_POST_NAME = _lto
# Use gcc-ar instead of ar for lto_plugin.so
AR      = $(BINPATH)/arm-none-eabi-gcc-ar
endif
...
## Psram type select.
##
ifeq ($(MTK_PSRAM_TYPE_VALUE),0)
COM_CFLAGS += -DMTK_SUPPORT_PSRAM_MODE_PSRAM_4MB_APM
else ifeq ($(MTK_PSRAM_TYPE_VALUE),1)
COM_CFLAGS += -DMTK_SUPPORT_PSRAM_MODE_PSRAM_8MB_APM
else ifeq ($(MTK_PSRAM_TYPE_VALUE),2)
COM_CFLAGS += -DMTK_SUPPORT_PSRAM_MODE_UHS_PSRAM_8MB
else ifeq ($(MTK_PSRAM_TYPE_VALUE),3)
COM_CFLAGS += -DMTK_SUPPORT_PSRAM_MODE_UHS_PSRAM_16MB
else ifeq ($(MTK_PSRAM_TYPE_VALUE),4)
COM_CFLAGS += -DMTK_SUPPORT_PSRAM_MODE_PSRAM_4MB_WB
else ifeq ($(MTK_PSRAM_TYPE_VALUE),5)
COM_CFLAGS += -DMTK_SUPPORT_PSRAM_MODE_PSRAM_8MB_WB
else
COM_CFLAGS += -DMTK_SUPPORT_PSRAM_MODE_PSRAM_4MB_APM
endif
...
COM_CFLAGS += -I$(SOURCE_DIR)/driver/CMSIS/Device/MTK/mt7933/Include
COM_CFLAGS += -I$(SOURCE_DIR)/driver/CMSIS/Include
COM_CFLAGS += -I$(SOURCE_DIR)/driver/chip/mt7933/inc
COM_CFLAGS += -I$(SOURCE_DIR)/middleware/MTK/connsys/inc
COM_CFLAGS += -I$(SOURCE_DIR)/driver/chip/inc
COM_CFLAGS += -I$(SOURCE_DIR)/driver/chip/mt7933/src/common/include
...
ifeq ($(MTK_SECURE_BOOT_ENABLE),y)
COM_CFLAGS += -I$(SOURCE_DIR)/middleware/MTK/sboot/inc
endif
...
DRV_CHIP_PATH 		= $(SOURCE_DIR)/driver/chip/mt7933
DRV_BSP_PATH 		= $(SOURCE_DIR)/driver/board/mt7933_hdk
...
ifeq ($(MTK_SECURE_BOOT_ENABLE),y)
MID_SECURE_BOOT_PATH    = $(SOURCE_DIR)/middleware/MTK/sboot
endif
#Homekit & Security
