...
uint32_t hal_memview_cm4_to_dsp0(uint32_t cm4_address)
{
    ...
    if ((cm4_address < 0x20000000)) {
        dsp0_address = cm4_address + 0x80000000;
    } else if ((cm4_address >= 0x40000000) && (cm4_address < 0x60000000)) {
        dsp0_address = cm4_address - 0x20000000;
    } else {
...
{
    uint32_t dsp1_address = 0;

    dsp1_address = cm4_address;
...
uint32_t hal_memview_dsp0_to_cm4(uint32_t dsp0_address)
{
    ...
    if ((dsp0_address >= 0x20000000) && (dsp0_address < 0x40000000)) {
        cm4_address = dsp0_address + 0x20000000;
    } else if ((dsp0_address >= 0x80000000) && (dsp0_address < 0xa0000000)) {
...
uint32_t hal_memview_dsp0_to_dsp1(uint32_t dsp0_address)
{
    ...
    if ((dsp0_address >= 0x20000000) && (dsp0_address < 0x40000000)) {
        dsp1_address = dsp0_address + 0x20000000;
    } else if ((dsp0_address >= 0x80000000) && (dsp0_address < 0xa0000000)) {
        dsp1_address = dsp0_address - 0x80000000;
    } else {
        dsp1_address = dsp0_address;
    }
...
uint32_t hal_memview_dsp0_to_infrasys(uint32_t dsp0_address)
{
    ...
    if ((dsp0_address >= 0x20000000) && (dsp0_address < 0x40000000)) {
        infrasys_address = dsp0_address + 0x20000000;
    } else if ((dsp0_address >= 0x80000000) && (dsp0_address < 0xa0000000)) {
...
uint32_t hal_memview_dsp1_to_dsp0(uint32_t dsp1_address)
{
    ...
    if ((dsp1_address < 0x20000000)) {
        dsp0_address = dsp1_address + 0x80000000;
    } else if ((dsp1_address >= 0x40000000) && (dsp1_address < 0x60000000)) {
        dsp0_address = dsp1_address - 0x20000000;
    } else {
        dsp0_address = dsp1_address;
    }

    return dsp0_address;
}

uint32_t hal_memview_dsp1_to_infrasys(uint32_t dsp1_address)
{
    uint32_t infrasys_address = 0;

    infrasys_address = dsp1_address;
...
uint32_t hal_memview_infrasys_to_dsp0(uint32_t infrasys_address)
{
    ...
    } else if ((infrasys_address >= 0x40000000) && (infrasys_address < 0x60000000)) {
        dsp0_address = infrasys_address - 0x20000000;
    } else {
