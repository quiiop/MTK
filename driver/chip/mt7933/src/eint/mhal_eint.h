 ...
 */
extern int mtk_mhal_eint_enable_debounce(hal_eint_number_t eint_num, void __iomem *eint_base);
/**
 ...
 * Return -#EINVAL if eint_num is invalid argument.\n
 */
extern int mtk_mhal_eint_disable_debounce(hal_eint_number_t eint_num, void __iomem *eint_base);
 ...
 */
extern int mtk_mhal_eint_set_polarity(hal_eint_number_t eint_num, u32 pol, void __iomem *eint_base);
 ...
 */
extern int mtk_mhal_eint_set_dual(hal_eint_number_t eint_num, u32 dual, void __iomem *eint_base);
 ...
 *@param [in] eint_num : eint_num is the EINT number, the value is
 *                                  HAL_EINT_NUMBER_0 ~ HAL_EINT_NUMBER_MAX-1.
 *@param [in] irq : irq number corresponding to eint_num.
 ...
 * Return -#EINVAL if eint_num is invalid argument.\n
 */
extern int mtk_mhal_eint_set_debounce(hal_eint_number_t eint_num, u32 irq, u32 debounce_time, void __iomem *eint_base);
