...
#define ADC_CH_ID_MASK  (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4))
/**< ADC channel id mask*/
#define ADC_DATA_MASK  (BITS(5, 16))
/**< ADC sample data mask*/
#define ADC_DATA_BIT_OFFSET     5
...
typedef enum {
    ...
    ADC_BIT8 = 0x0100,
    /**< ADC channel8 bit map*/
    ADC_BIT9 = 0x0200,
    /**< ADC channel9 bit map*/
    ADC_BIT10 = 0x0400,
    /**< ADC channel10 bit map*/
    ADC_BIT11 = 0x0800
                /**< ADC channel11 bit map*/
} adc_channel_bit_map;
...
struct cbuffer {
    uint16_t read_idx;  /* current read index */
...
struct mtk_adc_controller {
    ...
    struct cbuffer dma_rx_buf;      /* transmit buffer */
    struct uart_vfifo rx_vfifo; /* adc rx dma control structure */
