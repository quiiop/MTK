...
#define KEYPAD_FLAG_STA             (0x1)
#define KEYPAD_FLGA_EN              (0x1)
#define KEYPAD_FLAG_MODE            (0x1)
...
#define KEYPAD_KP_SEL_COL_OFFSET     (0x0A)
#define KEYPAD_KP_SEL_ROW_OFFSET     (0x04)
...
#endif /* #ifndef __HAL_KEYPAD_INTERNAL_H__ */
