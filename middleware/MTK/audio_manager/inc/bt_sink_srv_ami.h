 ...
 * @return                  Audio type.
 */
extern bt_sink_srv_am_type_t bt_sink_srv_ami_get_current_scenario(void);
 ...
 */
extern bt_sink_srv_am_volume_level_t bt_sink_srv_ami_get_a2dp_max_volume_level(void);
 ...
 * @return                  Audio volume level.
 */
extern bt_sink_srv_am_volume_level_t bt_sink_srv_ami_get_a2dp_default_volume_level(void);
 ...
 * @return                  Audio volume level.
 */
extern bt_sink_srv_am_volume_level_t bt_sink_srv_ami_get_vp_max_volume_level(void);
 ...
 * @return                  Audio volume level.
 */
extern bt_sink_srv_am_volume_level_t bt_sink_srv_ami_get_vp_default_volume_level(void);
 ...
 * @return                  Audio volume level.
 */
extern bt_sink_srv_am_volume_level_t bt_sink_srv_ami_get_lineIN_max_volume_level(void);
 ...
 * @return                  Audio volume level.
 */
extern bt_sink_srv_am_volume_level_t bt_sink_srv_ami_get_lineIN_default_volume_level(void);

#if defined (AIR_BT_ULTRA_LOW_LATENCY_ENABLE) || defined (AIR_WIRED_AUDIO_ENABLE) || defined (AIR_BLE_AUDIO_DONGLE_ENABLE)
extern bt_sink_srv_am_volume_level_t bt_sink_srv_ami_get_usb_voice_sw_max_volume_level(void);
extern bt_sink_srv_am_volume_level_t bt_sink_srv_ami_get_usb_voice_sw_default_volume_level(void);
extern bt_sink_srv_am_volume_level_t bt_sink_srv_ami_get_usb_music_sw_max_volume_level(void);
extern bt_sink_srv_am_volume_level_t bt_sink_srv_ami_get_usb_music_sw_default_volume_level(void);
#endif /* #if defined (AIR_BT_ULTRA_LOW_LATENCY_ENABLE) || defined (AIR_WIRED_AUDIO_ENABLE) || defined (AIR_BLE_AUDIO_DONGLE_ENABLE) */
