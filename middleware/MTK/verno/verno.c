...
#endif /* #if (PRODUCT_VERSION == 2523) || (PRODUCT_VERSION == 2533) */

char build_date_time_str[] = __DATE__ " " __TIME__;
char sw_verno_str[] = MTK_SDK_VERSION;
#ifdef DaliyBuildTime
char official_ver_str[] = DaliyBuildTime;
#else /* #ifdef DaliyBuildTime */
char official_ver_str[] = "Not a official release project! \0";
#endif /* #ifdef DaliyBuildTime */
