...
#include "prompt_control.h"
#endif /* #ifdef MTK_PROMPT_SOUND_ENABLE */
...
#else /* #if defined(MP3_DEBUG_LOG) */
#define MP3_DEBUG_PRINTF(message...)
#endif /* #if defined(MP3_DEBUG_LOG) */
...
#endif /* #if defined(MTK_AUDIO_MP3_CODEC_AWS_SUPPORT) */
