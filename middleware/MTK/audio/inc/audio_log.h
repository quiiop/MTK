...
#else /* #ifdef AUDIO_USE_MSGID_LOG */
#define audio_src_srv_report(fmt, cnt, arg...)    LOG_I(AudSrc, (fmt), ##arg)
#define audio_src_srv_err(fmt, cnt, arg...)       LOG_E(AudSrc, (fmt), ##arg)
...
#endif /* #ifdef AUDIO_USE_MSGID_LOG */

#ifdef __cplusplus
}
#endif /* #ifdef __cplusplus */

#endif /* #ifndef __AUDIO_LOG_H__ */
