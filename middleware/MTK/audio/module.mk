...
ifeq ($(MTK_TEMP_REMOVE), y)
  ...
  ifeq ($(MTK_NVDM_ENABLE), y)
    ...
    ifeq ($(IC_CONFIG),mt7933)
      AUDIO_FILES += $(AUDIO_SRC)/port/mt7933/src/audio_nvdm.c
      AUDIO_FILES += $(AUDIO_SRC)/port/mt7933/src/nvkey.c
    else
...
ifeq ($(MTK_AUDIO_MP3_ENABLED), y)
  ifeq ($(IC_CONFIG),mt7687)
    ...
    ifeq ($(IC_CONFIG),mt7682)
	  ...
	  AUDIO_FILES += $(AUDIO_SRC)/src/audio_internal_service.c
      AUDIO_FILES += $(AUDIO_SRC)/mp3_codec/src/mp3_codec_7933.c
      LIBS += $(SOURCE_DIR)/prebuilt/middleware/MTK/audio/mp3_codec/lib/arm_cm4/libmp3dec.a
    else
...
ifeq ($(MTK_BT_CODEC_ENABLED),y)
    ...
    LIBS += $(SOURCE_DIR)/prebuilt/middleware/MTK/audio/sbc_codec/lib/libsbc_decoder.a
endif
...
ifeq ($(IC_CONFIG),mt7933)
  CFLAGS += -I$(SOURCE_DIR)/middleware/MTK/audio/port/mt7933/inc
else
...
ifeq ($(MTK_BT_CODEC_ENABLED),y)
    ...
    CFLAGS  += -I$(SOURCE_DIR)/prebuilt/middleware/MTK/audio/sbc_codec/inc
