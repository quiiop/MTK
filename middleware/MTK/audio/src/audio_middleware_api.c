...
void audio_middleware_set_default_enhancement_parameters(void)
{
...
#else /* #if PRODUCT_VERSION != 2533 // TODO: not using this method, we may set default enhancement in spicific file */
    speech_update_common(eaps->speech_common_parameter.speech_common_parameter);
...
#endif /* #if PRODUCT_VERSION != 2533 // TODO: not using this method, we may set default enhancement in spicific file */
