...
#define DSP_DTCM_BASE        0x40040000
/*****************************************************************************
 *                  REGISTER      TABLE
 *****************************************************************************/
...
enum {
    ...
    RUNSTALL = 3,
    STATVECTOR_SEL = 4,
    AUTO_BOOT_SW_RESET_B = 5 /* not used in this project */
...
#define DSP_TCM_OFFSET       (DSP_REG_BASE + 0x00b0)    /* not used in this project */
#define DSP_DDR_OFFSET       (DSP_REG_BASE + 0x00b4)    /* not used in this project */
#define DSP_INTFDSP          (DSP_REG_BASE + 0x00d0)    /* not used in this project: [0]: dsp0_intfdsp */
#define DSP_INTFDSP_CLR      (DSP_REG_BASE + 0x00d4)    /* not used in this project: [0]: dsp_intclr */
#define DSP_SRAM_PD_SW1      (DSP_REG_BASE + 0x00d8)    /* [31:0]: sram_pd_sw_31_0 */
#define DSP_SRAM_PD_SW2      (DSP_REG_BASE + 0x00dc)    /* [20:0]: sram_pd_sw_52_32 */
#define DSP_OCD              (DSP_REG_BASE + 0x00e0)
#define DSP_RG_DSP_IRQ_POL   (DSP_REG_BASE + 0x00f0)    /* not used in this project */
#define DSP_DSP_IRQ_EN       (DSP_REG_BASE + 0x00f4)    /* not used in this project */
#define DSP_DSP_IRQ_LEVEL    (DSP_REG_BASE + 0x00f8)    /* not used in this project */
#define DSP_DSP_IRQ_STATUS   (DSP_REG_BASE + 0x00fc)    /* not used in this project */
#define DSP_RG_INT2CIRQ      (DSP_REG_BASE + 0x0114)    /* DSP2CPU and CPU2DSP and DSP2SPM irq */
#define DSP_RG_INT_POL_CTL0  (DSP_REG_BASE + 0x0120)    /* dsp gpio irq polarity 0 */
#define DSP_RG_INT_EN_CTL0   (DSP_REG_BASE + 0x0130)    /* dsp gpio irq enable 0 */
#define DSP_RG_INT_LV_CTL0   (DSP_REG_BASE + 0x0140)    /* dsp gpio irq level 0 */
#define DSP_RG_INT_STATUS0   (DSP_REG_BASE + 0x0150)    /* dsp gpio irq status 0 */
#define DSP_PDEBUGSTATUS0    (DSP_REG_BASE + 0x0200)    /* PDebugData latch info by wdt irq trigger */
#define DSP_PDEBUGSTATUS1    (DSP_REG_BASE + 0x0204)    /* PDebugData latch info by wdt irq trigger */
#define DSP_PDEBUGSTATUS2    (DSP_REG_BASE + 0x0208)    /* PDebugData latch info by wdt irq trigger */
#define DSP_PDEBUGSTATUS3    (DSP_REG_BASE + 0x020c)    /* PDebugData latch info by wdt irq trigger */
#define DSP_PDEBUGSTATUS4    (DSP_REG_BASE + 0x0210)    /* PDebugData latch info by wdt irq trigger */
#define DSP_PDEBUGSTATUS5    (DSP_REG_BASE + 0x0214)    /* PDebugData latch info by wdt irq trigger */
#define DSP_PDEBUGSTATUS6    (DSP_REG_BASE + 0x0218)    /* PDebugData latch info by wdt irq trigger */
#define DSP_PDEBUGSTATUS7    (DSP_REG_BASE + 0x021c)    /* PDebugData latch info by wdt irq trigger */
#define DSP_DSP2PSRAM_PRIORITY           (DSP_REG_BASE + 0x0220)  /* not used in this project */
...
#define DSP_AUDIO_DSP_EMI_BASE_ADDR      (DSP_REG_BASE + 0x02E0)  /* not used in this project, use DSP_EMI_MAP instead */
#define DSP_AUDIO_DSP_SHARED_IRAM        (DSP_REG_BASE + 0x02E4)  /* not used in this project */
