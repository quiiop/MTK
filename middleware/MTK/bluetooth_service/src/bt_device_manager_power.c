...
static void BT_DM_POWER_DUMP_STATE(void)
{
...
static void bt_dm_power_reset_state_update(void)
{
    BT_DM_POWER_DUMP_STATE();
...
static void bt_dm_power_state_update(void)
{
