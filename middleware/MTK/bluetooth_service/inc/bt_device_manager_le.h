...
/**
 * @brief     This function show all bonding info in log message.
 * @return    None.
 */
void bt_device_manager_le_show_bonding_info(void);

/**
 * @brief     This function show all conntion info in log message.
 * @return    None.
 */
void bt_device_manager_le_show_conn_info(void);

/**
 * @brief     This function cang get connection handle by address.
 * @param[in] bt_addr      is a pointer to the peer bt address.
...
#endif /* #ifndef __BT_DEVICE_MANAGER_LE_H__ */
