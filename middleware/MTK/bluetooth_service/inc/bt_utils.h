...
void *bt_utils_memory_alloc(size_t size);
void bt_utils_memory_free(void *ptr);
void *bt_utils_memset(void *dest, int value, size_t size);
void *bt_utils_memcpy(void *dest, const void *src, size_t size);
int bt_utils_memcmp(const void *s1, const void *s2, size_t size);
