...
cmd_t fota_cli[] = {
    { "e",      "erases 4KB, param <addr>",                 _fota_cli_erase, NULL  },
    { "w",      "write <addr> <length> <char>",             _fota_cli_write, NULL  },
    { "r",      "read <addr> length",                       _fota_cli_read, NULL  },
    { "gpio",   "gpio pin to pull",                         _fota_cli_gpio, NULL  },
#ifndef MTK_FOTA_DUAL_IMAGE_ENABLE
    { "go",     "write trigger flag",                       _fota_cli_trigger, NULL },
#ifndef __ICCARM__  /* exclude tftp downloading from IAR */
    { "dl",     "download by tftp, <ip> <file> [w]",        _fota_cli_dl, NULL  },
#endif
    { "httpdl", "download by http, <url>",                  _fota_cli_dl_by_http, NULL },
#else
    { "dual",   "dual image download, <ip>",                _fota_cli_dl_dual, NULL },
#endif /* MTK_FOTA_DUAL_IMAGE_ENABLE */
    { NULL,     NULL,                                       NULL, NULL }
};
