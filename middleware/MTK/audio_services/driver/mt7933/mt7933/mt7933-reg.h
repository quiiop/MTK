#ifndef _MT7933_REG_H_
#define _MT7933_REG_H_
...
#define AFE_ADDA_DL_SCR_SPL_CON0        0x2dc4
...
#define AUD_TCON1_PDN_DMIC_TML              BIT(14)
#define AUD_TCON1_PDN_DMIC2_BCLK            BIT(11)
#define AUD_TCON1_PDN_DMIC1_BCLK            BIT(10)
...
#define AFE_GAIN1_CON0_EN_MASK          BIT(0)
#define AFE_GAIN1_CON0_MODE_MASK        GENMASK(7, 3)
#define AFE_GAIN1_CON0_MODE_VAL(x)      (((x) &0x1f) << 3)
#define AFE_GAIN1_CON0_SAMPLE_PER_STEP_MASK     GENMASK(15, 8)
#define AFE_GAIN1_CON0_SAMPLE_PER_STEP_VAL(x)     (((x) & 0xFF) << 8)
...
#define ASYS_TCON_REG_START_POINT_VAL(x)    (((x) & 0x1f) << 16)
...
#define ETDM_OUT_CON1_LRCK_WIDTH(x)     ((((x) - 1) & 0x1FF) << 20)
