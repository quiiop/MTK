...
#define MTK_LE_CAP_STREAM_COMMON
...
/**
 * @brief                       This function check the number of ASEs had been configured by peer device.
 * @return                      The handle ID of the second ASE which had been configured by peer device.
 */
