...
#else /* #ifdef MTK_SYSLOG_VERSION_2 */
#define bt_sink_srv_report_id(_message, art_cnt,...) LOG_I(sink_srv, _message, ##__VA_ARGS__)
#endif /* #ifdef MTK_SYSLOG_VERSION_2 */
#define bt_sink_srv_music_report(_message,...) LOG_I(sink_music, (_message), ##__VA_ARGS__)
#else /* #ifdef __BT_SINK_SRV_DEBUG_INFO__ */
#define bt_sink_srv_report(_message,...);
#define bt_sink_srv_report_id(_message, art_cnt,...);
#define bt_sink_srv_music_report(_message,...);
#endif /* #ifdef __BT_SINK_SRV_DEBUG_INFO__ */
...
#endif /* #ifndef __BT_SINK_SRV_UTILS_H__ */
