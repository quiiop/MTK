...
/* Definition for MTK_COMMON new feature or bug. */
#ifdef AIR_LE_AUDIO_ENABLE
#define MTK_COMMON_LE_MCP_EVT    //Support MCP event update, and no transfer to AVRCP
#define MTK_COMMON_LE_VCP_EVT    //Support VCP event update
#define MTK_COMMON_LE_STATUS_EVT //Support sink event update for LE only. Keep BT_SINK_SRV_EVENT_STATE_CHANGE for EDR.
#endif
...
/**
  ...
  * @{
  * The Sink is a Bluetooth service which integrates HFP, HSP, A2DP, AVRCP and PBAPC profiles.
...
#ifdef MTK_COMMON_LE_MCP_EVT
#define BT_SINK_MODULE_LE_MCP  ((BT_MODULE_CUSTOM_SINK) | (0x9U << BT_SINK_MODULE_OFFSET)) /**< Prefix of the LE MCP module. 0xF8190000*/
#endif
#ifdef MTK_COMMON_LE_VCP_EVT
#define BT_SINK_MODULE_LE_VCP  ((BT_MODULE_CUSTOM_SINK) | (0xAU << BT_SINK_MODULE_OFFSET)) /**< Prefix of the LE VCP module. 0xF81A0000*/
#endif
 ...
 */
typedef uint32_t bt_sink_srv_status_t;
...
#ifdef MTK_COMMON_LE_MCP_EVT
/* Some basic action will use AVRCP's action.
   But some LE Audio actions will be redefined here.
*/
#define BT_SINK_SRV_ACTION_LE_GET_CTR_OPCODES (BT_SINK_MODULE_AVRCP_ACTION | 0x021U) /**< This action sends a request to get remote supported control opcodes*/
#define BT_SINK_SRV_ACTION_LE_GET_PLAYER_NAME (BT_SINK_MODULE_AVRCP_ACTION | 0x022U) /**< This action sends a request to get remote media player name*/
#define BT_SINK_SRV_ACTION_LE_GET_TRACK_TITLE (BT_SINK_MODULE_AVRCP_ACTION | 0x023U) /**< This action sends a request to get remote LE device`s track title*/
#define BT_SINK_SRV_ACTION_LE_GET_TRACK_DURATION (BT_SINK_MODULE_AVRCP_ACTION | 0x024U) /**< This action sends a request to get remote LE device`s track duration*/
#define BT_SINK_SRV_ACTION_LE_GET_TRACK_POSITION (BT_SINK_MODULE_AVRCP_ACTION | 0x025U) /**< This action sends a request to get remote LE device`s track position*/

#endif

#ifdef MTK_COMMON_LE_VCP_EVT
#define BT_SINK_SRV_ACTION_LE_GET_VOLUME_INFOMATION (BT_SINK_MODULE_AVRCP_ACTION | 0x030U) /**< This action sends a request to get local volume information*/
#endif
...
#define BT_SINK_MODULE_EVENT_MASK     0xFFFFF000U  /**< Mask for Bluetooth Sink Event. 0xFFFFF000U */
...
#ifdef MTK_COMMON_LE_MCP_EVT
#define BT_SINK_MODULE_LE_MCP_EVENT   ((BT_SINK_MODULE_LE_MCP) | (0x1U << BT_SINK_MODULE_SUB_TYPE_OFFSET))  /**< Prefix of the LE MCP event. 0xF8191000*/
#endif
#ifdef MTK_COMMON_LE_VCP_EVT
#define BT_SINK_MODULE_LE_VCP_EVENT   ((BT_SINK_MODULE_LE_VCP) | (0x1U << BT_SINK_MODULE_SUB_TYPE_OFFSET))  /**< Prefix of the LE VCP event. 0xF81A1000*/
#endif
...
/* Common event */
#define BT_SINK_SRV_EVENT_STATE_CHANGE          (BT_SINK_MODULE_COMMON_EVENT | 0x000U)  /**< This event indicates the status of sink service has changed. 0xF8112000*/
#define LE_SINK_SRV_EVENT_REMOTE_INFO_UPDATE    (BT_SINK_MODULE_COMMON_EVENT | 0x001U)  /**< This event indicates the status of le audio . 0xF8112001*/
#ifdef MTK_COMMON_LE_STATUS_EVT
#define LE_SINK_SRV_EVENT_STATE_CHANGE          (BT_SINK_MODULE_COMMON_EVENT | 0x002U)  /**< This event indicates the status of sink service for LE has changed. 0xF8112002*/
#endif
...
#ifdef MTK_COMMON_LE_MCP_EVT
/* MCP event*/
#define BT_SINK_SRV_EVENT_LE_MCP_STATUS_CHANGE         (BT_SINK_MODULE_LE_MCP_EVENT | 0x000U) /**< MCP status change */
#define BT_SINK_SRV_EVENT_LE_MCP_EVENT_IND             (BT_SINK_MODULE_LE_MCP_EVENT | 0x001U) /**< To indicate we get MCP event,#ble_mcp_event_t, from LE Audio Stack */
#endif

#ifdef MTK_COMMON_LE_VCP_EVT
/* VCS event*/
#define BT_SINK_SRV_EVENT_LE_VCP_VOLUME_STATE_CHANGE   (BT_SINK_MODULE_LE_VCP_EVENT | 0x000U) /**< To indicate we get VCP volume state change event from LE Audio Stack */
#endif
...
/**
 *  @brief This structure is the callback parameters type of event(#BT_SINK_SRV_EVENT_LE_BIDIRECTION_CIS_UPDATE) which indicates the bidirection CIS link state.
 */
typedef struct {
...
/**
   *  @brief This structure is the parameters of #BT_SINK_SRV_EVENT_AVRCP_STATUS_CHANGE
   *            which indicates to current MCP status.
   */
typedef struct {
    bt_bd_addr_t   address; /**< The Current N9 binary type. */
    ble_mcs_media_state_t    mcp_status; /**< The Current MCP status. */
...
/**
   *  @brief This structure is the parameters of #BT_SINK_SRV_EVENT_LE_MCP_EVENT_IND
   *            which indicates to current MCP event.
   */
typedef struct {
    bt_msg_type_t event_type;   /**< Current MCP event type. */
    bt_status_t   status;       /**< Event status. */
    bool is_param_valid;        /**< Indicate param is valid or not. */
    bt_sink_srv_event_mcp_ind_param_t param;  /**< event parameter depened on MCP event type. */
...
#ifdef MTK_COMMON_LE_MCP_EVT
    bt_sink_srv_event_mcp_status_changed_ind_t mcp_status_change;/**< MCP status change*/
#endif
...
typedef struct {
    ...
    union {
        struct {
            ...
            bt_avrcp_get_element_attributes_response_value_t *attribute_list; /**< The list of response values for requested media attribute ID. Should be free after app taked.*/
        };
 ...
 * @}
 */
#endif /* #ifndef __BT_SINK_SRV_H__ */
