...
#define SINK_MODULE_MASK_A2DP      SINK_MODULE_MASK_OFFSET(BT_SINK_MODULE_A2DP)         /**< To get the module offset of the #BT_MODULE_A2DP. */
#define SINK_MODULE_MASK_AVRCP     SINK_MODULE_MASK_OFFSET(BT_SINK_MODULE_AVRCP)        /**< To get the module offset of the #BT_MODULE_AVRCP. */
...
#endif /* #ifndef __BT_SINK_SRV_COMMON_H__ */
