...
typedef struct iperf_result_struct {
    int32_t data_size;
    int32_t send_time;
    char total_len[IPERF_REPORT_SIZE];
    char result[IPERF_REPORT_SIZE];
    char report_title[IPERF_REPORT_SIZE];
} iperf_result_t;
