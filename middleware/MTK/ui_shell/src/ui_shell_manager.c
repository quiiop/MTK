...
ui_shell_status_t ui_shell_set_pre_proc_func(ui_shell_proc_event_func_t proc_event)
{
    ...
    ui_shell_activity_internal_t *activity = (ui_shell_activity_internal_t *)ui_shell_al_zalloc(sizeof(ui_shell_activity_internal_t));
    if (activity) {
        ...
        size_t data_len)
{
    ...
    activity = (ui_shell_activity_internal_t *)ui_shell_al_zalloc(sizeof(ui_shell_activity_internal_t));
    if (activity) {
