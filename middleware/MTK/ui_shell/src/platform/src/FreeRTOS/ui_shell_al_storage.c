...
ui_shell_al_storage_status_t ui_shell_al_storage_write_data_item(const char *group_name,
                                                                 ...
                                                                 uint32_t size)
{ 
    return (ui_shell_al_storage_status_t)nvdm_write_data_item(group_name, data_item_name, (nvdm_data_item_type_t)type, buffer, size);
...
ui_shell_al_storage_status_t ui_shell_al_storage_read_data_item(const char *group_name,
                                                                ...
                                                                uint32_t *size)
{
    return (ui_shell_al_storage_status_t)nvdm_read_data_item(group_name, data_item_name, buffer, (uint32_t *)size);
}
