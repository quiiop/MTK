...
typedef struct ca_sta_set_ip_config
{
    ...
    int ipType; /* 1: IPv4, 2:IPv6, 3: FILS HLP DHCPv4 Rapid Commit */
} caStaSetIpConfig_t;
...
typedef enum wfa_enableType
{
    ...
    eDisable,
#ifdef _FREERTOS
    ENABLE_TYPE_ENUM_32_BIT = 0xffffffff
#endif
} wfaEnableType;
...
typedef struct ca_sta_set_security
{
    ...
    int  pmf;
#ifdef CONFIG_MTK_HE
    char keys[4][32];  /* 26 hex for WEP */
    int  activeKeyIdx; /* for WEP */
#endif
#ifdef CONFIG_MTK_WPA3
    char akmSuiteType;
    char clientCertificate[128];
...
enum
{
    MBO_FRAME_BTM_QUERY = 1,
    MBO_FRAME_ANQP_QUERY,
};

enum
{
    MBO_ANQP_QUERY_ID_NEIGHBOR_REPOERT_REQ = 1,
    MBO_ANQP_QUERY_ID_QUERY_LIST_WITH_CELL_PREF,
};
...
enum
{
    ...
    PROG_TYPE_LOC,
#ifdef CONFIG_MTK_MBO
    // must sync with prog_str_tbl in mtk_cs
    PROG_TYPE_MBO,
#endif
#ifdef CONFIG_MTK_HE
    PROG_TYPE_HE,
...
typedef enum wfa_preambleType
{
    ...
    eShort,
#ifdef _FREERTOS
    PREAMBLE_TYPE_ENUM_32_BIT = 0xffffffff
#endif
} wfaPreambleType;
...
#ifdef _FREERTOS
    TDLS_MODE_ENUM_32_BIT = 0xffffffff
#endif
} wfaTDLSMode;
...
typedef enum wfa_wfdDevType
{
    ...
    eDual,
#ifdef _FREERTOS
    WFA_WFDDEV_TYPE_ENUM_32_BIT = 0xffffffff
#endif
} wfaWfdDevType;
...
typedef enum wfa_UiInput
{
    ...
    eMultiTouch,
#ifdef _FREERTOS
    WFA_UIINPUT_ENUM_32_BIT = 0xffffffff
#endif
} wfaUiInput;
...
typedef enum wfa_AudioModes
{
    ...
    eDefaultAudioMode,
#ifdef _FREERTOS
    AUDIO_MODES_ENUM_32_BIT = 0xffffffff
#endif
} wfaAudioModes;
...
typedef enum wfa_VideoFormats
{
    ...
    e848x480p60,
#ifdef _FREERTOS
    VIDEO_FORMAT_ENUM_32_BIT = 0xffffffff
#endif
} wfavideoFormats;
...
typedef enum wfa_wfdsConnCapInfo
{
    ...
    eWfdsCliGO,
#ifdef _FREERTOS
    CONN_CAP_ENUM_32_BIT = 0xffffffff
#endif
} wfaWfdsConnCapInfo;
...
#ifdef CONFIG_MTK_HE
    char addba_req_size[5];
    char addba_resp_size[5];
    int bcc_mode;
    int mcs_fixedrate;
    int mcs_fixedrate_rate;
    BOOL ulTxBeforeTrig;
    unsigned char he_mcs_map;
    unsigned char txsp_stream;
    int fullBW_ULMUMIMO;
    int TWTinfoFrameTx;
#endif
...
#endif
#if CONFIG_MTK_HE
    BYTE output_bssid_ssid;
    char rxMac[WFA_MAC_ADDR_STR_LEN];
    int shortSsid;
    int maxChannelTime;
    int chnlFreq;
#endif
...
#ifdef CONFIG_MTK_COMMON
enum ENUM_CONSYS_CHIPID {
        CONSYS_CHIPID_UNKNOWN,
        MT6883,
        MT6885,
        MT6889,
};
...
#ifdef CONFIG_MTK_HE
typedef struct ca_sta_power_save
{
    char intf[WFA_IF_NAME_LEN];
    char prog[8];
    char pwrsave[8];
