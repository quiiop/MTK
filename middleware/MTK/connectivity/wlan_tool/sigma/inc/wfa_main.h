...
#ifdef _FREERTOS
#define DUT_CMD_UART_PORT   HAL_UART_1
#define DUT_TG_TASK_PRI     TCPIP_THREAD_PRIO /* same as lwip to avoid releasing buffer blocked TG */
#endif
...
#if !defined(_WINDOWS) && !defined(_FREERTOS)
#define min(a,b)        ((a) < (b) ? (a) : (b))
#define max(a,b)        ((a) > (b) ? (a) : (b))

#endif
extern char g_rssi[8];
#endif
