...
#endif
{
...
#ifdef CONFIG_MTK_COMMON
    NotDefinedYet,              /*    WFA_STA_SET_EAPAKAPRIME_TLV      (85)*/
    NotDefinedYet,              /*    WFA_STA_SET_EAPPWD_TLV           (86)*/
    NotDefinedYet,              /*    WFA_STA_COMMANDS_END             (87)*/
#endif
    wfaStaExecAction,           /*    WFA_STA_EXEC_ACTION_TLV          (88)*/
#ifdef CONFIG_MTK_WPA3
    wfaStaScan,                 /*    WFA_STA_SCAN_TLV                 (89)*/
#endif
    ...
    wfaApSetRFeature,           /*   WFA_AP_SET_RFEATURE_TLV              */
#endif

#ifdef CONFIG_MTK_HE
    wfaStaSetPowerSave,         /*   WFA_STA_POWER_SAVE_TLV               */
#endif
};
