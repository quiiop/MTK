...
int xcCmdProcStaSetIpConfig(char *pcmdStr, BYTE *aBuf, int *aLen)
{
    ...
    for(;;)
    {
        ...
        {
           str = strtok_r(NULL, ",", &pcmdStr);
           setip->ipType = atoi(str);
           DPRINT_INFO(WFA_OUT, "ip type %i\n", setip->ipType);
        }
        else
        {
...
int xcCmdProcStaSetSecurity(char *pcmdStr, BYTE *aBuf, int *aLen)
{
    ...
    for(;;)
    {
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy((char *)ssec->keys[0], str, 26);
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy((char *)ssec->keys[1], str, 26);
            DPRINT_INFO(WFA_OUT, "key2 %s\n", ssec->keys[1]);
        }
        else if(strcasecmp(str, "key3") == 0)
        {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy((char *)ssec->keys[2], str, 26);
            DPRINT_INFO(WFA_OUT, "key3 %s\n", ssec->keys[2]);
        }
        else if(strcasecmp(str, "key4") == 0)
        {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy((char *)ssec->keys[3], str, 26);
            DPRINT_INFO(WFA_OUT, "key4 %s\n", ssec->keys[3]);
        }
        else if(strcasecmp(str, "activeKey") == 0)
        {
            str = strtok_r(NULL, ",", &pcmdStr);
            ssec->activeKeyIdx =  atoi(str);
        }
#endif
    }
...
#ifndef WFA_PC_CONSOLE
    char *str;
    caStaSetPSK_t defparams = {"", "", "", "", 0, WFA_INVALID_BOOL};
                ...
                for (;;) {
                    ...
                    if (strcasecmp(str, "framename") == 0) {
                        ...
                        if (strcasecmp(str, "action") == 0)
                            he->eframe = HE_TYPE_ACTION;
                        else if (strcasecmp(str, "trigger") == 0)
                            he->eframe = HE_TYPE_TRIGGER;
                        else if (strcasecmp(str, "disassoc") == 0)
                            he->eframe = HE_TYPE_DISASSOC;
                        else if (strcasecmp(str, "deauth") == 0)
                            he->eframe = HE_TYPE_DEAUTH;
                    } else if (strcasecmp(str, "PPDUTxType") == 0) {
                        str = strtok_r(NULL, ",", &pcmdStr);

                        if (strcasecmp(str, "TB") == 0)
                            he->PPDUTxType = eEnable;
                        else
                            he->PPDUTxType = eDisable;
                    } else if (strcasecmp(str, "frame_cnt") == 0) {
                        str = strtok_r(NULL, ",", &pcmdStr);
                        he->frame_cnt = atoi(str);
                    } else if (strcasecmp(str, "protected") == 0) {
                        str = strtok_r(NULL, ",", &pcmdStr);
                        if (strcasecmp(str, "correctKey") == 0)
                            he->eProtected = PMF_PROT_CORRECTKEY;
                        else if (strcasecmp(str, "incorrectKey") == 0)
                            he->eProtected = PMF_PROT_INCORRECTKEY;
                        else if (strcasecmp(str, "unprotected") == 0)
                            he->eProtected = PMF_PROT_UNPROTECTED;
                    } else if (strcasecmp(str, "stationid") == 0) {
                        str = strtok_r(NULL, ",", &pcmdStr);
                        strncpy(he->staid, str, WFA_MAC_ADDR_STR_LEN - 1);
                        he->staid[WFA_MAC_ADDR_STR_LEN - 1] = '\0';
                    } else if (strcasecmp(str, "bssid") == 0) {
                        str = strtok_r(NULL, ",", &pcmdStr);
                        strncpy(he->bssid, str, WFA_MAC_ADDR_STR_LEN - 1);
                        he->bssid[WFA_MAC_ADDR_STR_LEN - 1] = '\0';
                        he->bssid_flag = 1;
                    }
                }
            }
            ...
            else if (strcasecmp(str, "MBO") == 0)
            {
                ...
                for(;;)
                {
                    ...
                    else if (strcasecmp(str, "framename") == 0)
                    {
                        ...
                        {
                            mbo->frame = MBO_FRAME_BTM_QUERY;
                        }
                        if (strcasecmp(str, "ANQPQuery") == 0)
                        {
                            mbo->frame = MBO_FRAME_ANQP_QUERY;
                        }

                    }
                    else if(strcasecmp(str, "DestMac") == 0 || strcasecmp(str, "Des_tMac") == 0)
                    {
                        str = strtok_r(NULL, ",", &pcmdStr);
                    ...
                    {
                        str = strtok_r(NULL, ",", &pcmdStr);
                        mbo->btmQueryReasonCode = atoi(str);
                    }
                    else if(strcasecmp(str, "ANQPQuery_ID") == 0)
                    {
                        str = strtok_r(NULL, ",", &pcmdStr);
                        if (strcasecmp(str, "NeighborReportReq") == 0)
                        {
                            mbo->anqpQueryId = MBO_ANQP_QUERY_ID_NEIGHBOR_REPOERT_REQ;
                        }
                        if (strcasecmp(str, "QueryListWithCellPref") == 0)
                        {
                            mbo->anqpQueryId = MBO_ANQP_QUERY_ID_QUERY_LIST_WITH_CELL_PREF;
                        }
                    }
...
#ifdef CONFIG_MTK_HE
    memset(staWirelessParams, 0, sizeof(caStaSetWireless_t));
    staWirelessParams->ulTxBeforeTrig = WFA_INVALID_BOOL;
    staWirelessParams->he_mcs_map = WFA_INVALID_BOOL;
#endif
    ...
    for(;;)
    {
        ...
        else if(strcasecmp(str, "program") == 0) // VHT or 11n or Voice
        {
            ...
            if(strcasecmp(staWirelessParams->program, "VHT") == 0)
            {
                ...
                char *substr = strtok_r(NULL, ",", &pcmdStr);
                if (strcasecmp(substr, "BW_SGNL") == 0)
                {
                    char *setvalues =strtok_r(NULL, ",", &pcmdStr);
                    if (setvalues!=NULL)
                        staWirelessParams->bw_sgnl = wfaStandardBoolParsing(setvalues);
                ...
                else if (strcasecmp(substr, "DYN_BW_SGNL") == 0)
                {
                    char *setvalues =strtok_r(NULL, ",", &pcmdStr);
                    if (setvalues!=NULL)
                        staWirelessParams->dyn_bw_sgnl = wfaStandardBoolParsing(setvalues);
        ...
        else if (strcasecmp(str, "BCC") == 0)
        {
            char *setvalues =strtok_r(NULL, ",", &pcmdStr);
            if (setvalues!=NULL) {
                if(strcasecmp(setvalues, "enable") == 0)
                    staWirelessParams->bcc_mode = 1;
                else if(strcasecmp(setvalues, "disable") == 0)
                    staWirelessParams->bcc_mode = 0;
            }
        }
        else if (strcasecmp(str, "mcs_fixedrate") == 0)
        {
            char *setvalues = strtok_r(NULL, ",", &pcmdStr);
            staWirelessParams->mcs_fixedrate = 1;
            staWirelessParams->mcs_fixedrate_rate = atoi(setvalues);
        }
        else if(strcasecmp(str, "ADDBAReq_BufSize") == 0)
        {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy(staWirelessParams->addba_req_size, str, 4);
        }
        else if(strcasecmp(str, "ADDBAResp_BufSize") == 0)
        {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy(staWirelessParams->addba_resp_size, str, 4);
        }
        else if(strcasecmp(str, "ULTxBeforeTrig") == 0)
        {
            str = strtok_r(NULL, ",", &pcmdStr);
            staWirelessParams->ulTxBeforeTrig = wfaStandardBoolParsing(str);
        }
#endif
#ifdef CONFIG_MTK_HE
        else if (strcasecmp(str, "nss_mcs_cap") == 0)
        {
            ...
            str = strtok_r(NULL, ",", &pcmdStr);
            strcpy(tmp, str);
            mcs = strtok_r(NULL, ";", &str);
            DPRINT_INFO(WFA_OUT, "mcs=%s  str=%s\n", mcs, str);

            if (strcasecmp(str, "0-11") == 0)
                staWirelessParams->he_mcs_map = 2;
            else if (strcasecmp(str, "0-9") == 0)
                staWirelessParams->he_mcs_map = 1;
            else
                staWirelessParams->he_mcs_map = 2;
        }
        else if (strcasecmp(str, "txsp_stream") == 0 )
        {
            ...
            if (strcasecmp(str, "2SS") == 0)
                staWirelessParams->txsp_stream = 2;
            else if (strcasecmp(str, "1SS") == 0)
                staWirelessParams->txsp_stream = 1;
            else
                staWirelessParams->txsp_stream = 0;
            DPRINT_INFO(WFA_OUT, "txsp_stream %d\n", staWirelessParams->txsp_stream);
        }
        else if (strcasecmp(str, "FullBW_ULMUMIMO") == 0)
        {
             str = strtok_r(NULL, ",", &pcmdStr);
             if (strcasecmp(str, "enable") == 0)
                    staWirelessParams->fullBW_ULMUMIMO = eEnable;
             else if (strcasecmp(str, "disable") == 0)
                    staWirelessParams->fullBW_ULMUMIMO = eDisable;
        }
        else if (strcasecmp(str, "TWTinfoFrameTx") == 0)
        {
             str = strtok_r(NULL, ",", &pcmdStr);
             if (strcasecmp(str, "enable") == 0)
                    staWirelessParams->TWTinfoFrameTx = eEnable;
             else if (strcasecmp(str, "disable") == 0)
                    staWirelessParams->TWTinfoFrameTx = eDisable;
        }
#endif
    }
...
int xcCmdProcStaSetRFeature(char *pcmdStr, BYTE *aBuf, int *aLen)
{
    ...
    memset(aBuf, 0, *aLen);
#ifdef CONFIG_MTK_HE
    rfeat->txsuppdu = WFA_INVALID_BOOL;
#endif
    for(;;)
    {
        str = strtok_r(NULL, ",", &pcmdStr);
        ...
        else if(strcasecmp(str, "Cellular_Data_Cap") == 0)
        {
            ...
            str = strtok_r(NULL, ",", &pcmdStr);
            rfeat->twt_param.twtChannel = atoi(str);
        } else if (strcasecmp(str, "FlowID") == 0) {
            str = strtok_r(NULL, ",", &pcmdStr);
            rfeat->twt_param.flowID = atoi(str);
        } else if (strcasecmp(str, "TWT_Operation") == 0) {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy(rfeat->twt_param.operation, str, 10);
        } else if (strcasecmp(str, "TWT_SuspendDuration") == 0) {
            str = strtok_r(NULL, ",", &pcmdStr);
            rfeat->twt_param.suspendDuration= atoi(str);
        } else if (strcasecmp(str, "TWT_ResumeDuration") == 0) {
            str = strtok_r(NULL, ",", &pcmdStr);
            rfeat->twt_param.resumeDuration= atoi(str);
        }
#endif
#ifdef CONFIG_MTK_HE
        else if (strcasecmp(str, "TxSUPPDU") == 0) {
            str = strtok_r(NULL, ",", &pcmdStr);
	    rfeat->txsuppdu = wfaStandardBoolParsing(str);
        }
#endif
    }
...
#if CONFIG_MTK_HE
		} else if (strcasecmp(str, "GetParameter") == 0) {
			str = strtok_r(NULL, ",", &pcmdStr);
			if (strcasecmp(str, "SSID_BSSID") == 0)
				staScan->output_bssid_ssid = 1;
		} else if (strcasecmp(str, "RxMac") == 0) {
			str = strtok_r(NULL, ",", &pcmdStr);
			strncpy(staScan->rxMac, str, WFA_MAC_ADDR_STR_LEN - 1);
		} else if (strcasecmp(str, "ShortSSID") == 0) {
			str = strtok_r(NULL, ",", &pcmdStr);
			staScan->shortSsid = strtol(str, NULL, 16);
		} else if (strcasecmp(str, "MaxChannelTime") == 0) {
			str = strtok_r(NULL, ",", &pcmdStr);
			if (strcasecmp(str, "Include") == 0)
				staScan->maxChannelTime = 1;
			else
				staScan->maxChannelTime = 0;
		} else if (strcasecmp(str, "ChnlFreq") == 0) {
			str = strtok_r(NULL, ",", &pcmdStr);
			staScan->chnlFreq = strtol(str, NULL, 10);
#endif
		}
	}
    ...
    for (;;) {
        ...
        if (strcasecmp(str, "name") == 0) {
            ...
            if (strcasecmp(str, "wpa2") == 0)
                ...
                apResetDefault->program = PROGRAME_TYPE_HE;
            else
    ...
    for (;;) {
        ...
        if (strcasecmp(str, "name") == 0) {
            ...
            if (strcasecmp(str, "11b") == 0)
                ...
                apSetWireless->mode = AP_MODE_11ax;
            else
            ...
            if (strcasecmp(str, "wpa2") == 0)
                ...
                apSetWireless->program = PROGRAME_TYPE_HE;
            else
            ...
            str = strtok_r(NULL, ",", &pcmdStr);
            apSetWireless->mcs_fixedrate = 1;
            apSetWireless->mcs_fixedrate_rate = atoi(str);
            DPRINT_INFO(WFA_OUT, "mcs_fixed_rate: %d\n",
                    apSetWireless->mcs_fixedrate_rate);
            ...
            str = strtok_r(NULL, ",", &pcmdStr);
            if (strcasecmp(str, "enable") == 0)
                apSetWireless->bcc_mode = 1;
            else if(strcasecmp(str, "disable") == 0)
                apSetWireless->bcc_mode = 0;
            DPRINT_INFO(WFA_OUT, "bcc_mode: %d\n", apSetWireless->bcc_mode);
        } else if(strcasecmp(str, "ADDBAReq_BufSize") == 0) {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy(apSetWireless->addba_req_size, str, 4);
            apSetWireless->addba_req_size[4] = '\0';
            DPRINT_INFO(WFA_OUT, "addba_req_size: %s\n", apSetWireless->addba_req_size);
        } else if(strcasecmp(str, "ADDBAResp_BufSize") == 0) {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy(apSetWireless->addba_resp_size, str, 4);
            apSetWireless->addba_resp_size[4] = '\0';
            DPRINT_INFO(WFA_OUT, "addba_resp_size: %s\n", apSetWireless->addba_resp_size);
        } else {
...
int xcCmdProcApSetRFeature(char *pcmdStr, BYTE *aBuf, int *aLen) {
    caAPRFeat_t *apSetRFeat = (caAPRFeat_t *) (aBuf + sizeof(wfaTLV));
    char *str;
    ...
    memset(aBuf, 0, *aLen);
    memset(apSetRFeat, 0, sizeof(caAPRFeat_t));
    ...
    for (;;) {
        ...
        if (strcasecmp(str, "name") == 0) {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy(apSetRFeat->dutName, str, WFA_IF_NAME_LEN - 1);
            apSetRFeat->dutName[WFA_IF_NAME_LEN - 1] = '\0';
            DPRINT_INFO(WFA_OUT, "name: %s\n", apSetRFeat->dutName);
        } else if (strcasecmp(str, "txBandwidth") == 0) {
            str = strtok_r(NULL, ",", &pcmdStr);
            if (strcasecmp(str, "20") == 0)
                apSetRFeat->width = CHANNEL_WIDTH_20;
            else if (strcasecmp(str, "40") == 0)
                apSetRFeat->width = CHANNEL_WIDTH_40;
            else if (strcasecmp(str, "80") == 0)
                apSetRFeat->width = CHANNEL_WIDTH_80;
            else if (strcasecmp(str, "160") == 0)
                apSetRFeat->width = CHANNEL_WIDTH_160;
            else
                apSetRFeat->width = CHANNEL_WIDTH_AUTO;
            DPRINT_INFO(WFA_OUT, "width: %d\n", apSetRFeat->width);
        } else if (strcasecmp(str, "mode") == 0) {
            str = strtok_r(NULL, ",", &pcmdStr);
            if (strcasecmp(str, "11b") == 0)
                apSetRFeat->mode = AP_MODE_11b;
            else if (strcasecmp(str, "11bg") == 0)
                apSetRFeat->mode = AP_MODE_11bg;
            else if (strcasecmp(str, "11bgn") == 0)
                apSetRFeat->mode = AP_MODE_11bgn;
            else if (strcasecmp(str, "11a") == 0)
                apSetRFeat->mode = AP_MODE_11a;
            else if (strcasecmp(str, "11g") == 0)
                apSetRFeat->mode = AP_MODE_11g;
            else if (strcasecmp(str, "11na") == 0)
                apSetRFeat->mode = AP_MODE_11na;
            else if (strcasecmp(str, "11ng") == 0)
                apSetRFeat->mode = AP_MODE_11ng;
            else if (strcasecmp(str, "11ac") == 0)
                apSetRFeat->mode = AP_MODE_11ac;
            else if (strcasecmp(str, "11ad") == 0)
                apSetRFeat->mode = AP_MODE_11ad;
            else if (strcasecmp(str, "11ax") == 0)
                apSetRFeat->mode = AP_MODE_11ax;
            else
                apSetRFeat->mode = AP_MODE_NONE;
            DPRINT_INFO(WFA_OUT, "mode: %d\n", apSetRFeat->mode);
        } else if (strcasecmp(str, "type") == 0) {
            str = strtok_r(NULL, ",", &pcmdStr);
            if (strcasecmp(str, "wpa2") == 0)
                apSetRFeat->program = PROGRAME_TYPE_WPA2;
            else if (strcasecmp(str, "wmm") == 0)
                apSetRFeat->program = PROGRAME_TYPE_WMM;
            else if (strcasecmp(str, "hs2") == 0)
                apSetRFeat->program = PROGRAME_TYPE_HS2;
            else if (strcasecmp(str, "hs2-r2") == 0)
                apSetRFeat->program = PROGRAME_TYPE_HS2_R2;
            else if (strcasecmp(str, "vht") == 0)
                apSetRFeat->program = PROGRAME_TYPE_VHT;
            else if (strcasecmp(str, "11n") == 0)
                apSetRFeat->program = PROGRAME_TYPE_11N;
            else if (strcasecmp(str, "60ghz") == 0)
                apSetRFeat->program = PROGRAME_TYPE_60GHZ;
            else if (strcasecmp(str, "loc") == 0)
                apSetRFeat->program = PROGRAME_TYPE_LOC;
            else if (strcasecmp(str, "wpa3") == 0)
                apSetRFeat->program = PROGRAME_TYPE_WPA3;
            else if (strcasecmp(str, "he") == 0)
                apSetRFeat->program = PROGRAME_TYPE_HE;
            else
                apSetRFeat->program = PROGRAME_TYPE_NONE;
            DPRINT_INFO(WFA_OUT, "program: %d\n", apSetRFeat->program);
        } else if(strcasecmp(str, "LTF") == 0) {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy(apSetRFeat->ltf, str, 5);
            DPRINT_INFO(WFA_OUT, "ltf: %s\n", apSetRFeat->ltf);
        } else if(strcasecmp(str, "GI") == 0) {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy(apSetRFeat->gi, str, 5);
    ...
    wfaEncodeTLV(WFA_AP_SET_RFEATURE_TLV, sizeof(caAPRFeat_t),
            (BYTE *) apSetRFeat, aBuf);
...
#ifdef CONFIG_MTK_HE
int xcCmdProcStaPowerSave(char *pcmdStr, BYTE *aBuf, int *aLen)
{
    caStaPowerSave_t *staPs = (caStaPowerSave_t *) (aBuf+sizeof(wfaTLV));
    char *str;
    ...
    for (;;) {
        ...
        if(strcasecmp(str, "interface") == 0) {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy(staPs->intf, str, 15);
        } else if (strcasecmp(str, "program") == 0) {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy(staPs->prog, str, 8);
        } else if (strcasecmp(str, "powersave") == 0) {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy(staPs->pwrsave, str, 8);
        }
    }

    wfaEncodeTLV(WFA_STA_POWER_SAVE_TLV, sizeof(caStaPowerSave_t), (BYTE *)staPs, aBuf);
    *aLen = 4 + sizeof(caStaPowerSave_t);
    return WFA_SUCCESS;
}
#endif
