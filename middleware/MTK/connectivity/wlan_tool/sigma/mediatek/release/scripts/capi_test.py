...
if TEST_ALL or TEST_MBO:
    send_resp(client_socket, "dev_send_frame,program,MBO,interface,wlan0,DestMac,00:01:02:03:04:05,FrameName,ANQPQuery,ANQPQuery_ID,NeighborReportReq")
    send_resp(client_socket, "dev_send_frame,program,MBO,interface,wlan0,DestMac,00:01:02:03:04:05,FrameName,ANQPQuery,ANQPQuery_ID,QueryListWithCellPref")
    send_resp(client_socket, "dev_send_frame,NAME,STAUT,interface,wlan0,Program,MBO,FrameName,BTMQuery,Dest_MAC,00:01:02:03:04:05,Cand_List,0,BTMQuery_Reason_Code,1")

if TEST_ALL or TEST_6E:
    send_resp(client_socket, "sta_set_security,type,SAE,interface,wlan0,ssid,MyNetwork,KeyMgmtType,WPA2,EncpType,AES-CCMP,passphrase,12345678,sae_pwe,looping")
    send_resp(client_socket, "sta_set_security,type,SAE,interface,wlan0,ssid,MyNetwork,KeyMgmtType,WPA2,EncpType,AES-CCMP,passphrase,12345678,sae_pwe,h2e")
    send_resp(client_socket, "sta_set_security,type,SAE,interface,wlan0,ssid,MyNetwork,KeyMgmtType,WPA2,EncpType,AES-CCMP,passphrase,12345678,sae_pwe,XXXXXX")

    send_resp(client_socket, "sta_send_frame,interface,wlan0,Frame,HE,framename,action")
    send_resp(client_socket, "sta_send_frame,interface,wlan0,Frame,HE,framename,trigger")

    send_resp(client_socket, "sta_set_wireless,interface,wlan0,program,HE,BCC,enable,mcs_fixedrate,5,ADDBAReq_BufSize,55,ADDBAResp_BufSize,66,ULTxBeforeTrig,enable")

    send_resp(client_socket, "sta_set_wireless,interface,wlan0,program,HE,nss_mcs_cap,2;0-9")
    send_resp(client_socket, "sta_set_wireless,interface,wlan0,program,HE,txsp_stream,2SS")

    send_resp(client_socket, "sta_reset_default,interface,wlan0,prog,HE")
    send_resp(client_socket, "sta_set_wireless,interface,wlan0,program,HE,FullBW_ULMUMIMO,enable")
    send_resp(client_socket, "sta_set_wireless,interface,wlan0,program,HE,FullBW_ULMUMIMO,disable")
    send_resp(client_socket, "sta_set_wireless,interface,wlan0,program,HE,nss_mcs_cap,2;0-9")
    send_resp(client_socket, "sta_set_wireless,interface,wlan0,program,HE,txsp_stream,2SS")
    send_resp(client_socket, "sta_reset_default,interface,wlan0,prog,HE")
    send_resp(client_socket, "sta_set_rfeature,interface,wlan0,prog,HE,ChSwitchMode,Disable,OMCtrl_ULMUDisable,0")
    send_resp(client_socket, "sta_set_rfeature,interface,wlan0,prog,HE,ChSwitchMode,Disable,OMCtrl_ULMUDisable,1")
    send_resp(client_socket, "sta_reset_default,interface,wlan0,prog,HE")
    send_resp(client_socket, "sta_set_rfeature,interface,wlan0,prog,HE,TWT_Operation,suspend")
    send_resp(client_socket, "sta_set_rfeature,interface,wlan0,prog,HE,TWT_Operation,suspend,TWT_SuspendDuration,10")
    send_resp(client_socket, "sta_set_rfeature,interface,wlan0,prog,HE,TWT_Operation,resume,TWT_ResumeDuration,100")
    send_resp(client_socket, "sta_set_wireless,interface,wlan0,program,HE,TWTinfoFrameTx,enable")
    send_resp(client_socket, "sta_set_wireless,interface,wlan0,program,HE,TWTinfoFrameTx,disable")
