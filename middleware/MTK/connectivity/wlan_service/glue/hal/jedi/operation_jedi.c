	...
	struct test_configuration *configs)
{
	...
	UniCmdMuruParameterSet(ad, (RTMP_STRING *)&MuruManCfg,
			UNI_CMD_MURU_MANUAL_CONFIG);
#endif
...
#ifdef WIFI_UNIFIED_COMMAND
	UniCmdMuruParameterSet(ad, (RTMP_STRING *)&SetMuTxPktCnt,
			UNI_CMD_MURU_SET_MU_TX_PKT_CNT);
#else
