...
static unsigned int boots_stress_thread_status;
static unsigned int boots_stress_thread_should_stop;
...
static void boots_stress_mem_analysis(void)
{
    uint32_t i;
