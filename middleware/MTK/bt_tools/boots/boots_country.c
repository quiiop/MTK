...
#define USAGE_COUNTRY_GET_LIMIT_DETAILS \
    "      [c]ountry_code: country code value\n" \
    "      [f]ile path: full path and name of table file, default:/vendor/firmware/BtCountryLimit.dat "
...
#define USAGE_COUNTRY_CREATE_LIMIT_DETAILS \
    "      [c]ountry_code: country code value\n" \
    "      file path: full path and name of country code [t]able file, default:/vendor/firmware/BtCountryLimit.dat " \
    "      [f]ile path: full path and name of table file, default:/vendor/firmware/BtTxPwrLimit.bin "

#define USAGE_COUNTRY_GET_SRS_DETAILS \
    "      [c]ountry_code: country code value\n" \
    "      [f]ile path: full path and name of table file, default:/vendor/firmware/BtSRS.dat "
...
boots_country_cmds_s country_commands[] = {
    { "get_limit", mtk_boots_country_get_limit, "Get power limit with country code. [-c <country_code>] [-f <file_path>]", USAGE_COUNTRY_GET_LIMIT_DETAILS, false },
    { "set_limit", mtk_boots_country_set_limit, "Set power limit with country code. [-c <country_code>] [-f <file_path>] [-b <0-9>] [-e <0-9>] [-m <0-9>]", USAGE_COUNTRY_SET_LIMIT_DETAILS, false },
    { "dump_limit", mtk_boots_country_dump_limit, "Dump power limit with all country code. [-f <file_path>]", USAGE_COUNTRY_DUMP_LIMIT_DETAILS, false },
    { "create_table", mtk_boots_country_create_limit_table, "Create power limit table. [-c <country_code>] [-t <file_path>] [-f <file_path>]", USAGE_COUNTRY_CREATE_LIMIT_DETAILS, false },
    { "get_srs", mtk_boots_country_get_srs, "Get SRS with country code. [-c <country_code>] [-f <file_path>]", USAGE_COUNTRY_GET_SRS_DETAILS, false },
    { "set_srs", mtk_boots_country_set_srs, "Set SRS with country code. [-c <country_code>] [-f <file_path>] [-s <SRS>]", USAGE_COUNTRY_SET_SRS_DETAILS, false },
    { "dump_srs", mtk_boots_country_dump_srs, "Dump SRS with all country code. [-f <file_path>]", USAGE_COUNTRY_DUMP_SRS_DETAILS, false },
