...
#define LX_CM33_IRQ_B		(INT_LEVEL(1) | INTERRUPT_ID(10))
#define LX_APDMA_IRQ0_B	(INT_LEVEL(1) | INTERRUPT_ID(11))
#define LX_APDMA_IRQ1_B	(INT_LEVEL(1) | INTERRUPT_ID(12))
#define LX_APDMA_IRQ2_B	(INT_LEVEL(1) | INTERRUPT_ID(13))
#define LX_APDMA_IRQ3_B	(INT_LEVEL(1) | INTERRUPT_ID(14))
#define LX_APDMA_IRQ4_B	(INT_LEVEL(1) | INTERRUPT_ID(15))
#define LX_APDMA_IRQ5_B	(INT_LEVEL(1) | INTERRUPT_ID(16))
#define LX_APDMA_IRQ6_B	(INT_LEVEL(1) | INTERRUPT_ID(17))
#define LX_APDMA_IRQ7_B	(INT_LEVEL(1) | INTERRUPT_ID(18))
#define LX_APDMA_IRQ8_B	(INT_LEVEL(1) | INTERRUPT_ID(19))
#define LX_APDMA_IRQ9_B	(INT_LEVEL(1) | INTERRUPT_ID(20))
#define LX_APDMA_IRQ10_B	(INT_LEVEL(1) | INTERRUPT_ID(21))
#define LX_APDMA_IRQ11_B	(INT_LEVEL(1) | INTERRUPT_ID(22))
#define LX_BTCVSD_IRQ_B	(INT_LEVEL(1) | INTERRUPT_ID(23))
#define LX_BTAP_IRQ_B		(INT_LEVEL(1) | INTERRUPT_ID(24))
#define LX_CONNSYS_IRQ_B	(INT_LEVEL(1) | INTERRUPT_ID(25))
#define LX_I2C1_IRQ_B		(INT_LEVEL(1) | INTERRUPT_ID(26))
#define LX_I2C2_IRQ_B		(INT_LEVEL(1) | INTERRUPT_ID(27))
#define LX_PWM_IRQ_B		(INT_LEVEL(1) | INTERRUPT_ID(28))

#define MAX_IRQ_NUM		29
#define MAX_INT_LEVEL		24

#define AUDIO_IRQn			LX_AFE_IRQ_B
#define CM33_IRQn			LX_CM33_IRQ_B
