...
#define TOP_CLK_REG_BASE   (0x30020000)
  #define TOP_CLK_REG_SIZE    (0x4000)

#define DSP_VER_REG_BASE   (0x30034000)
  #define DSP_VER_REG_SIZE    (0x4000)

#define TOP_PLL_REG_BASE  (0x300C0000)
  #define TOP_PLL_REG_SIZE   (0x10000)

#define TOP_SPM_REG_BASE  (0x300D0000)
  #define TOP_SPM_REG_SIZE   (0x10000)

#define DSP_AUDIO_SRAM_BASE             (0x40040000)
  #define DSP_AUDIO_SRAM_SIZE             (0x00040000)

#define TOP_SPM_REG_BASE  (0x300D0000)
#define TOP_SPM_REG_SIZE   (0x10000)

#define DSP_AFE_BASE                    (0x40080000)
  #define DSP_AFE_SIZE                    (0x00020000)
#define DSP_REG_REMAP_BASE              (0x41000000)
  #define DSP_REG_REMAP_SIZE            (0x4000)
#define DSP_TIMER_BASE                  (0x41000000)
#define DSP_UART0_BASE                  (0x41001000)
#define DSP_IRQ_BASE                    (0x41002000)
#define DSP_REG_BASE                    (0x41003000) /* DSPCFG base */
#define DSP_WDT_BASE                    (0x41003400)
#define DSP_BTSYS_REG_REMAP_BASE        (0x60830000)
#define DSP_BTSYS_REG_REMAP_SIZE        (0x00001000) /*Must be aligned in 4KB, dsp restrictions*/
#define DSP_N10_SRAM_REMAP_BASE         (0x60840000)
#define DSP_N10_SRAM_REMAP_SIZE         (0x00020000)
...
/* DSP IRQ CONFIGS */
#define RG_DSPIRQS_CM33_TO_DSP_INT_EN      (DSP_IRQ_BASE + 0x100)
#define RG_DSPIRQS_CM33_TO_DSP_INT_TRIG      (DSP_IRQ_BASE + 0x104)
#define RG_DSPIRQS_CM33_TO_DSP_INT_STS      (DSP_IRQ_BASE + 0x108)
#define RG_DSPIRQS_DSP_TO_CM33_INT_EN      (DSP_IRQ_BASE + 0x110)
#define RG_DSPIRQS_DSP_TO_CM33_INT_TRIG      (DSP_IRQ_BASE + 0x114)
#define RG_DSPIRQS_DSP_TO_CM33_INT_STS      (DSP_IRQ_BASE + 0x118)

#define RG_INT2CIRW							(DSP_REG_BASE + 0x114)
