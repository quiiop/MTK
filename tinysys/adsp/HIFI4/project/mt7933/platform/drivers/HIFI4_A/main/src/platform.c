...
#ifdef CFG_SPM_SUPPORT
    spm_init();
    spm_sleep_mode(BYPASS_ULTRA_LOW_POWER_MODE);
    spm_int_enable(1, ALL_TRIGGER_BIT);
#endif
...
{
    {
        .vaddr          = TOP_CLK_REG_BASE,
        .size           = TOP_CLK_REG_SIZE,
    ...
    {
        .vaddr          = TOP_PLL_REG_BASE,
        .size           = TOP_PLL_REG_SIZE,
        .access_right   = XTHAL_AR_RW,
        .memory_type    = XTHAL_MEM_DEVICE,
        .enable         = MPU_ENTRY_ENABLE,
    },
    {
        .vaddr          = TOP_SPM_REG_BASE,
        .size           = TOP_SPM_REG_SIZE,
        .access_right   = XTHAL_AR_RW,
        .memory_type    = XTHAL_MEM_DEVICE,
        .enable         = MPU_ENTRY_ENABLE,
    },
    ...
    {
        .vaddr          = DSP_BTSYS_REG_REMAP_BASE,
        .size           = DSP_BTSYS_REG_REMAP_SIZE,
        .access_right   = XTHAL_AR_RW,
        .memory_type    = XTHAL_MEM_NON_CACHEABLE,
        .enable         = MPU_ENTRY_ENABLE
    },
    {
        .vaddr          = DSP_N10_SRAM_REMAP_BASE,
        .size           = DSP_N10_SRAM_REMAP_SIZE,
        .access_right   = XTHAL_AR_RW,
        .memory_type    = XTHAL_MEM_NON_CACHEABLE,
        .enable         = MPU_ENTRY_ENABLE
    },
    {
        .vaddr          = CFG_HIFI4_SRAM_ADDRESS,
        .size           = CFG_HIFI4_SRAM_SIZE,
        .access_right   = XTHAL_AR_RWX,
        .memory_type    = XTHAL_MEM_WRITEBACK,
        .enable         = MPU_ENTRY_ENABLE,
    },
    {
        .vaddr          = CFG_HIFI4_SRAM_NONCACHE_ADDRESS,
        .size           = CFG_HIFI4_SRAM_NONCACHE_SIZE,
        .access_right   = XTHAL_AR_RW,
        .memory_type    = XTHAL_MEM_NON_CACHEABLE,
        .enable         = MPU_ENTRY_ENABLE,
    },
...
const char* MTK_prvGetHeapMemTypeStr( MTK_eMemoryType eMemType )
{
    switch ( eMemType )
    {
    case MTK_eMemDefault:
        return "Heap(DtcmNormalNC)";
    case MTK_eMemDramNormal:
        return "Heap(DramNormal)";
    case MTK_eMemDramNormalNC:
        return "Heap(DramNormalNC)";
    default:
        return "UNKNOWN";
    }
}
