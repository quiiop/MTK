...
MEMORY
{
  sram0_seg :                         	org = 0xA0000000, len = 0x400
  ...
  sram7_seg :                         	org = 0xA000061C, len = 0x4B1E4
  psram0_seg :                        	org = 0xA0050000, len = 0xFC000
}
...
_memmap_mem_sram_end   = 0xa004b800;
_memmap_mem_psram_start = 0xa0050000;
_memmap_mem_psram_end   = 0xa014c000;

/*  Memory segment boundary addresses:  */
_memmap_seg_sram0_start = 0xa0000000;
_memmap_seg_sram0_max   = 0xa0000400;
...
_memmap_seg_sram7_max   = 0xa004b800;
_memmap_seg_psram0_start = 0xa0050000;
_memmap_seg_psram0_max   = 0xa014c000;

_rom_store_table = 0;
PROVIDE(_memmap_reset_vector = 0xa0000000);
PROVIDE(_memmap_vecbase_reset = 0xa0000400);
/* Various memory-map dependent cache attribute settings: */
_memmap_cacheattr_wb_base = 0x00100000;
_memmap_cacheattr_wt_base = 0x00300000;
_memmap_cacheattr_bp_base = 0x00400000;
_memmap_cacheattr_unused_mask = 0xFF0FFFFF;
_memmap_cacheattr_wb_trapnull = 0x44144440;
_memmap_cacheattr_wba_trapnull = 0x44144440;
_memmap_cacheattr_wbna_trapnull = 0x44244440;
_memmap_cacheattr_wt_trapnull = 0x44344440;
_memmap_cacheattr_bp_trapnull = 0x44444440;
_memmap_cacheattr_wb_strict = 0x00100000;
_memmap_cacheattr_wt_strict = 0x00300000;
_memmap_cacheattr_bp_strict = 0x00400000;
_memmap_cacheattr_wb_allvalid = 0x44144444;
_memmap_cacheattr_wt_allvalid = 0x44344444;
_memmap_cacheattr_bp_allvalid = 0x44444444;
_memmap_region_map = 0x00000020;
...
SECTIONS
{
  ...
  PROVIDE(__stack = 0xa004b800);
  _heap_sentry = 0xa004b800;
  ...
  {
    _psram_rodata_start = ABSOLUTE(.);
    *(.psram.rodata)
    . = ALIGN (4);
    _psram_rodata_end = ABSOLUTE(.);
  } >psram0_seg :psram0_phdr

  .psram.text : ALIGN(4)
  {
    _psram_text_start = ABSOLUTE(.);
    *(.psram.literal .psram.text)
    . = ALIGN (4);
    _psram_text_end = ABSOLUTE(.);
  } >psram0_seg :psram0_phdr

  .psram.data : ALIGN(4)
  {
    _psram_data_start = ABSOLUTE(.);
    *(.psram.data)
    . = ALIGN (4);
    _psram_data_end = ABSOLUTE(.);
  } >psram0_seg :psram0_phdr
