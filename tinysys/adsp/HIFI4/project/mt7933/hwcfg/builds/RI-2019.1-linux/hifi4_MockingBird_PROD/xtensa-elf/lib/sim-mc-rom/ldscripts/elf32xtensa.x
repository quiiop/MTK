/* This linker script generated from xt-genldscripts.tpp for LSP sim-mc-rom */
...
ERROR: The sim-mc-rom LSP is unavailable.
ERROR: section .dram0.data not found
ERROR: for directive PLACE SECTIONS(...) WITH_SECTION(.dram0.data)
ERROR: in LSP memory map line 25 (sim-mc-rom/memmap.xmm)
