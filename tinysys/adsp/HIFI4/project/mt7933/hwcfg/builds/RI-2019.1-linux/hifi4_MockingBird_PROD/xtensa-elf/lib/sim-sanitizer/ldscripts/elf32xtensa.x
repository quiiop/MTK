/* This linker script generated from xt-genldscripts.tpp for LSP sim-sanitizer */
...
MEMORY
{
  ...
  sanmem0_seg :                       	org = 0xE0000000, len = 0x20000000
}
...
PHDRS
{
  ...
  sanmem0_phdr PT_LOAD;
  sanmem0_bss_phdr PT_LOAD;
}
...
_memmap_mem_sanmem_start = 0xe0000000;
_memmap_mem_sanmem_end   = 0xffffffff;
...
_memmap_seg_sanmem0_start = 0xe0000000;
_memmap_seg_sanmem0_max   = 0xffffffff;

_rom_store_table = 0;
PROVIDE(_memmap_reset_vector = 0xa0000640);
PROVIDE(_memmap_vecbase_reset = 0xa0000400);
/* Various memory-map dependent cache attribute settings: */
_memmap_cacheattr_wb_base = 0x10100000;
_memmap_cacheattr_wt_base = 0x30300000;
_memmap_cacheattr_bp_base = 0x40400000;
_memmap_cacheattr_unused_mask = 0x0F0FFFFF;
_memmap_cacheattr_wb_trapnull = 0x14144440;
_memmap_cacheattr_wba_trapnull = 0x14144440;
_memmap_cacheattr_wbna_trapnull = 0x24244440;
_memmap_cacheattr_wt_trapnull = 0x34344440;
_memmap_cacheattr_bp_trapnull = 0x44444440;
_memmap_cacheattr_wb_strict = 0x10100000;
_memmap_cacheattr_wt_strict = 0x30300000;
_memmap_cacheattr_bp_strict = 0x40400000;
_memmap_cacheattr_wb_allvalid = 0x14144444;
_memmap_cacheattr_wt_allvalid = 0x34344444;
_memmap_cacheattr_bp_allvalid = 0x44444444;
_memmap_region_map = 0x000000A0;
...
SECTIONS
{
  ...
  .san.bss (NOLOAD) : ALIGN(8)
  {
    . = ALIGN (8);
    _san_bss_start = ABSOLUTE(.);
    *(.san.bss)
    . = ALIGN (8);
    _san_bss_end = ABSOLUTE(.);
    _memmap_seg_sanmem0_end = ALIGN(0x8);
  } >sanmem0_seg :sanmem0_bss_phdr
