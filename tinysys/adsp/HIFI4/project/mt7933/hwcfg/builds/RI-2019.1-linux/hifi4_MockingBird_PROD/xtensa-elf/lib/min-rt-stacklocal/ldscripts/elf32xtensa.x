/* This linker script generated from xt-genldscripts.tpp for LSP min-rt-stacklocal */
...
ERROR: The min-rt-stacklocal LSP is unavailable.
ERROR: section .dram0.bss not found
ERROR: for directive PLACE SECTIONS(...) WITH_SECTION(.dram0.bss)
ERROR: in LSP memory map line 25 (min-rt-stacklocal/memmap.xmm)
