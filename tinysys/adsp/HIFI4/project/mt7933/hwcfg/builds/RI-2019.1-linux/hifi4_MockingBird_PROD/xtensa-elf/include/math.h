...
#if (XCHAL_HAVE_HIFI3_VFPU == 1)        || \
    (XCHAL_HAVE_HIFI4_VFPU == 1)        || \
    (XCHAL_HAVE_FUSION_FP)              || \
    (XCHAL_HAVE_FUSIONG_SP_VFPU == 1)   || \
    (XCHAL_HAVE_FUSIONG_DP_VFPU == 1)   || \
    (XCHAL_HAVE_PDX4 == 1)              || \
    ((XCHAL_HAVE_PDXNX == 1) && (XCHAL_PDX_SIMD32 == 8))
#define USE_VFPU  1
#else
#define USE_VFPU  0
#endif
...
_END_C_LIB_DECL
 ...
 #if defined(__cplusplus) && !defined(_LIBCPP_VERSION) /* TENSILICA libc++ */
...
#define __MATH_H_EINLINE extern __inline
#else 
