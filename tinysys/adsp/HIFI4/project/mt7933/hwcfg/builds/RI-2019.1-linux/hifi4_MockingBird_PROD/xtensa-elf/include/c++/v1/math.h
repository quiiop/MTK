...
// TENSILICA: xclib - disable some of declarations, they are already present
// in xclib. Newlib - add several missing declarations used here.
...
#if !(defined(_AIX) || defined(__sun__) || defined(__XCLIB__))
inline _LIBCPP_INLINE_VISIBILITY
float
...
#endif // !(defined(_AIX) || defined(__sun__) || defined(__XCLIB__))
