...
MEMORY
{
  ...
  sram8_seg :                         	org = 0xA0000640, len = 0x5FFF9C0
}
...
_memmap_mem_sram_end   = 0xa6000000;
...
_memmap_seg_sram8_max   = 0xa6000000;
...
SECTIONS
{
  ...
  PROVIDE(__stack = 0xa6000000);
  _heap_sentry = 0xa6000000;
  .debug  0 :  { *(.debug) }
  .line  0 :  { *(.line) }
