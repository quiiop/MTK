...
#if (__cplusplus >= 201103) && !defined(_HAVE_XCLIB)
#error   "For C++11 or later with newlib, you must use -stdlib=libc++"
#include "For C++11 or later with newlib, you must use -stdlib=libc++"
#endif
