...
show_usage() {
    ...
    echo ""
    echo "Example:"
    echo "  $0 mt8518-default-project"
    echo "      -> build mt8518-default-project project"
    echo "  $0 clean"
    echo "      -> clean out folder"
    echo "  $0 mt8518-default-project clean"
    echo "      -> only clean out/mt8518-default-project folder"
    echo "  $0 list"
