...
#else
#define STRM_A2DP_LOG_E(_message, arg_cnt, ...)  PRINTF_E(_message, ##__VA_ARGS__)
#define STRM_A2DP_LOG_W(_message, arg_cnt, ...)  PRINTF_W(_message, ##__VA_ARGS__)
#define STRM_A2DP_LOG_I(_message, arg_cnt, ...)  PRINTF_I(_message, ##__VA_ARGS__)
#define STRM_A2DP_LOG_D(_message, arg_cnt, ...)  PRINTF_D(_message, ##__VA_ARGS__)
#endif
