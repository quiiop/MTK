 ...
 *============================================================================*/
#define MSG_ID2STR(x) [x]=#x

const char *msg_string[MSG_TO_DSP_NUM] = {
    MSG_ID2STR(MSG_TO_DSP_CREATE_VA_T),
    MSG_ID2STR(MSG_TO_DSP_DESTROY_VA_T),
    MSG_ID2STR(MSG_TO_DSP_CREATE_RECORD_T),
    MSG_ID2STR(MSG_TO_DSP_DESTROY_RECORD_T),
    MSG_ID2STR(MSG_TO_DSP_AP_SUSPEND_T),
    MSG_ID2STR(MSG_TO_DSP_AP_RESUME_T),
    MSG_ID2STR(MSG_TO_DSP_SCENE_VA_VAD),
    MSG_ID2STR(MSG_TO_DSP_SCENE_VA_KEYWORD),
    MSG_ID2STR(MSG_TO_DSP_SCENE_VA_AEC),
    MSG_ID2STR(MSG_TO_DSP_SCENE_VA_PREPROCESSING),
    MSG_ID2STR(MSG_TO_DSP_SCENE_VA_RECORD),
    MSG_ID2STR(MSG_TO_DSP_SCENE_VA_VOICE_UPLOAD_DONE),
    MSG_ID2STR(MSG_TO_DSP_SCENE_VA_BEAMFORMING),
    MSG_ID2STR(MSG_TO_DSP_SCENE_VA_VAD_FORCE_OK),
    MSG_ID2STR(MSG_TO_DSP_SCENE_VA_KEYWORD_FORCE_OK),
    MSG_ID2STR(MSG_TO_DSP_HOST_PORT_STARTUP),
    MSG_ID2STR(MSG_TO_DSP_HOST_HW_PARAMS),
    MSG_ID2STR(MSG_TO_DSP_HOST_PREPARE),
    MSG_ID2STR(MSG_TO_DSP_HOST_TRIGGER_START),
    MSG_ID2STR(MSG_TO_DSP_HOST_TRIGGER_STOP),
    MSG_ID2STR(MSG_TO_DSP_HOST_HW_FREE),
    MSG_ID2STR(MSG_TO_DSP_HOST_CLOSE),
    MSG_ID2STR(MSG_TO_DSP_DSP_PORT_STARTUP),
    MSG_ID2STR(MSG_TO_DSP_DSP_HW_PARAMS),
    MSG_ID2STR(MSG_TO_DSP_DSP_PREPARE),
    MSG_ID2STR(MSG_TO_DSP_DSP_TRIGGER_START),
    MSG_ID2STR(MSG_TO_DSP_DSP_TRIGGER_STOP),
    MSG_ID2STR(MSG_TO_DSP_DSP_HW_FREE),
    MSG_ID2STR(MSG_TO_DSP_DSP_CLOSE),
    MSG_ID2STR(MSG_TO_DSP_DEBUG_START),
    MSG_ID2STR(MSG_TO_DSP_DEBUG_STOP),
    MSG_ID2STR(MSG_TO_DSP_CREATE_RECORD_T),
    MSG_ID2STR(MSG_TO_DSP_DESTROY_RECORD_T),
};
...
static int audio_ipi_msg_dispatcher(int id, void *data, unsigned int len);
...
void audio_ready_notify_host(void)
{
