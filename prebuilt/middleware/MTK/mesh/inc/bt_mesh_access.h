...
typedef struct {
    ...
    uint16_t dst_addr;      /**< The destination address of this message. The value is the same as element_addr for unicast address.*/
    uint16_t element_addr;  /**< The element address that the dst_addr belongs to. */
    ...
    uint8_t bearer;         /**< The received bearer, which 0 means ADV and 1 means GATT.*/
    uint32_t seq_number;    /**< The sequence number of this message.*/
    uint32_t iv_index;    /**< The IV index of this message.*/
