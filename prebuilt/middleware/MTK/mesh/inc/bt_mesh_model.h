...
/*!
    @brief Deleting subscription for the specified model.
    @param[in] subscription_address is the subscribed address.
    @param[in] model_id is the id of the target model.
    @param[in] unicast_addr is the unicast address of the element.
    @return
    ...
    #BT_MESH_ERROR_INVALID_ADDR, the address to subscribe is invalid. \n
*/
bt_mesh_status_t bt_mesh_model_delete_subscription(bt_mesh_address_t subscription_address, uint32_t model_id, uint16_t unicast_addr);

/*!
    @brief Deleting all subscription for the specified model.
    @param[in] model_id is the id of the target model.
    @param[in] unicast_addr is the unicast address of the element.
    @return
    #BT_MESH_SUCCESS, packets successfully sent. \n
    #BT_MESH_ERROR_INVALID_ADDR, the address to subscribe is invalid. \n
*/
bt_mesh_status_t bt_mesh_model_delete_all_subscription(uint32_t model_id, uint16_t unicast_addr);
