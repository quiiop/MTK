...
#define GPIO_PORT17_MODE   MODE_2 // 2:UART0_RX : Used for UART0_RX
#define GPIO_PORT18_MODE   MODE_2 // 2:UART0_TX : Used for UART0_TX
...
#define GPIO_PORT23_MODE   MODE_2 // 2:DSP_URXD0 : Used for DSP_URXD0
#define GPIO_PORT24_MODE   MODE_2 // 2:DSP_UTXD0 : Used for DSP_UTXD0
