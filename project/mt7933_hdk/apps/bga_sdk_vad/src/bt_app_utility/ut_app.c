...
#if (defined(MTK_BT_BAS_SERVICE_ENABLE) || defined(MTK_BLE_SMTCN_ENABLE)) && defined(__MTK_BT_MESH_ENABLE__)
    //only mesh or only gatts not need switch
...
#endif /* #if (defined(MTK_BT_BAS_SERVICE_ENABLE) || defined(MTK_BLE_SMTCN_ENABLE)) && defined(__MTK_BT_MESH_ENABLE__) */
