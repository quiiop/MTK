...
extern int _cyberon_data_start[];
...
#define CYBERON_DATA_START      ((const uint32_t)_cyberon_data_start)
...
#define PHY_SYSRAM_MASK         ( MEM_MASK( 0x80000000  ) )
#define VIRTUAL_SYSRAM_MASK     ( MEM_MASK( 0x08000000  ) )
#define PHY_FLASH_MASK          ( MEM_MASK( 0x90000000  ) )
#define VIRTUAL_FLASH_MASK      ( MEM_MASK( 0x18000000  ) )
#define PHY_RAM_MASK            ( MEM_MASK( 0xA0000000  ) )
#define VIRTUAL_RAM_MASK        ( MEM_MASK( 0x10000000  ) )
...
extern int _non_init_sysram_bss_start[];
extern int _non_init_sysram_bss_end[];
...
extern int _non_init_ram_bss_start[];
extern int _non_init_ram_bss_end[];
...
#define SYSRAM_NON_INIT_BSS_START   ((const uint32_t)_non_init_sysram_bss_start)
#define SYSRAM_NON_INIT_BSS_END     ((const uint32_t)_non_init_sysram_bss_end)
...
#define RAM_NON_INIT_BSS_START      ((const uint32_t)_non_init_ram_bss_start)
#define RAM_NON_INIT_BSS_END        ((const uint32_t)_non_init_ram_bss_end)
