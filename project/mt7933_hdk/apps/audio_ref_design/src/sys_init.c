...
#include "hal_dcxo.h"
#endif /* #ifdef HAL_DCXO_MODULE_ENABLED */
...
#endif /* #if defined(MTK_MINI_DUMP_ENABLE) && defined(MTK_NVDM_ENABLE) */
...
#endif /* #ifndef MTK_DEBUG_LEVEL_NONE */
...
#endif /* #ifdef HAL_ASIC_MPU_MODULE_ENABLED */
...
#ifdef HAL_CLK_FORCE_RTC_XOSC
    hal_rtc_osc32_sel(RTC_OSC_SRC_XOSC);
#endif /* #ifdef HAL_CLK_FORCE_RTC_XOSC */

    hal_clock_mux_select(HAL_CLOCK_SEL_F32K, CLK_F32K_CLKSEL_RTC);
#endif /* #ifdef HAL_RTC_MODULE_ENABLED */
}
...
#endif /* #if !defined(MTK_DEBUG_LEVEL_NONE) && !defined(MTK_HAL_PLAIN_LOG_ENABLE) && defined(MTK_NVDM_ENABLE) */
...
#endif /* #ifdef MTK_NVDM_ENABLE */
#endif /* #if !defined(MTK_DEBUG_LEVEL_NONE) && !defined(MTK_HAL_PLAIN_LOG_ENABLE) */
