...
#if defined(UT_HAL_ENABLE) && defined (UT_HAL_PMU_MODULE_ENABLE)
#include "hal_pmu.h"
...
ut_status_t ut_hal_pmu(void)
{
    ...
    printf("pmu set dvs end.\r\n");
    return UT_STATUS_OK;
}

#endif /* #if defined(UT_HAL_ENABLE) && defined (UT_HAL_PMU_MODULE_ENABLE) */
