...
#endif /* #ifdef BRINGUP_WIFI_ENABLE */


#ifdef MTK_PERIPHERAL_CI_UT_ENABLED
#include "ci_cli.h"
#endif /* #ifdef MTK_PERIPHERAL_CI_UT_ENABLED */
...
uint8_t ci_minicli_test_cmd(uint8_t len, char *param[]);
...
static cmd_t   _cmds_normal[] = {
    ...
    { "wifi",   "wifi commands", NULL, wifi_init_cli },
    { "iwpriv", "WiFi iw command", iwpriv_cli, NULL },
#ifdef MTK_IPERF_ENABLE
    IPERF_CLI_ENTRY
#endif /* #ifdef MTK_IPERF_ENABLE */
#else /* #ifdef MTK_WF_IWPRIV_CLI_ENABLE */
...
#endif /* #ifdef MTK_FATFS_ENABLE */
#ifdef MTK_PERIPHERAL_CI_UT_ENABLED
    { "ci", "ci cli cmd", ci_cli, NULL },
    { "logout", "CLI logout", cli_logout, NULL },
#endif /* #ifdef MTK_PERIPHERAL_CI_UT_ENABLED */
    SDIO_CLI_ENTRY
    MSDC_CLI_ENTRY
    { NULL, NULL, NULL, NULL }
