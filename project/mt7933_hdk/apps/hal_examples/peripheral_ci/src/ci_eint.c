...
static hal_gpio_pin_t _Tst_GPIO_PIN = HAL_GPIO_14;
static hal_gpio_pin_t _Trigger_GPIO_PIN = HAL_GPIO_13;
static hal_eint_number_t _Tst_EINT_num = HAL_EINT_NUMBER_6;
