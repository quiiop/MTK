/*
 * Generated by Mediatek Easy PinMux Tool Version 2.7.0 for 7933. Copyright Mediatek Inc. (C) 2015.
 * 2021-09-11 00:18:24:0459
...
#define GPIO_PORT6_MODE   MODE_1 // 1:SDIO_CLK : Used for SDIO_CLK
#define GPIO_PORT7_MODE   MODE_1 // 1:SDIO_CMD : Used for SDIO_CMD
#define GPIO_PORT8_MODE   MODE_1 // 1:SDIO_DAT0 : Used for SDIO_DAT0
#define GPIO_PORT9_MODE   MODE_1 // 1:SDIO_DAT1 : Used for SDIO_DAT1
#define GPIO_PORT10_MODE   MODE_1 // 1:SDIO_DAT2 : Used for SDIO_DAT2
#define GPIO_PORT11_MODE   MODE_1 // 1:SDIO_DAT3 : Used for SDIO_DAT3
#define GPIO_PORT12_MODE   MODE_4 // 4:WIFI_TXD : Used for WIFI_TXD
#define GPIO_PORT13_MODE   MODE_4 // 4:UART1_RX : Used for UART1_RX
...
#define GPIO_PORT19_MODE   MODE_5 // 5:UART1_TX : Used for UART1_TX
#define GPIO_PORT20_MODE   MODE_1 // 1:CONN_WF_MCU_AICE_TCKC : Used for CONN_WF_MCU_AICE_TCKC
#define GPIO_PORT21_MODE   MODE_1 // 1:CONN_WF_MCU_AICE_TMSC : Used for CONN_WF_MCU_AICE_TMSC
#define GPIO_PORT22_MODE   MODE_1 // 1:CONN_BGF_MCU_AICE_TCKC : Used for CONN_BGF_MCU_AICE_TCKC
#define GPIO_PORT23_MODE   MODE_1 // 1:CONN_BGF_MCU_AICE_TMSC : Used for CONN_BGF_MCU_AICE_TMSC
#define GPIO_PORT24_MODE   MODE_1 // 1:ADSP_JTAG_TDO : Used for ADSP_JTAG_TDO
#define GPIO_PORT25_MODE   MODE_1 // 1:ADSP_JTAG_TCK : Used for ADSP_JTAG_TCK
#define GPIO_PORT26_MODE   MODE_1 // 1:ADSP_JTAG_TRST : Used for ADSP_JTAG_TRST
#define GPIO_PORT27_MODE   MODE_1 // 1:ADSP_JTAG_TDI : Used for ADSP_JTAG_TDI
#define GPIO_PORT28_MODE   MODE_1 // 1:ADSP_JTAG_TMS : Used for ADSP_JTAG_TMS
...
#define GPIO_PORT42_MODE   MODE_2 // 2:DBSYS_SWCLK_TCLK : Used for DBSYS_SWCLK_TCLK
#define GPIO_PORT43_MODE   MODE_0 // 0:GPIO43 : Used for GPIO43
#define GPIO_PORT44_MODE   MODE_2 // 2:DBSYS_SWDIO_TMS : Used for DBSYS_SWDIO_TMS
