 ...
 * @{
 * @addtogroup mt793x_hdk_websocket_client websocket_client
 * @{

@par Overview
  - Project Demonstration
    - This project demonstrates the Wi-Fi connectivity and websocket client application 
...
@par Run the examples
  ...
  - Example 2. Websocket Client Application Example
    - Make sure the nework is connected.
    - Enter Websocket client CLI
        \code
        websocket client
        \endcode 
    ...
    - Websocket serve is based on website: http://www.websocket-test.com/ 
      which ws server is: ws://121.40.165.18:8080
*/
/**
 * @}
 * @}
