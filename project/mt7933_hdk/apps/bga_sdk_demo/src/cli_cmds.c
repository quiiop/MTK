...
#ifdef MTK_LITTLEFS_ENABLE
extern cmd_t lfs_cli[];
#endif
//Acsip(+)
extern cmd_t barcode_scanner_cli[];
//Acsip(end)
...
#endif
#ifdef MTK_LITTLEFS_ENABLE
    { "lfs", "lfs cli cmd", NULL, &lfs_cli[0] },
 #endif
    //Acsip(+)
    LED_TEST_CLI_ENTRY
    { "barcode", "barcode scanner", NULL, &barcode_scanner_cli[0] },
    //Acsip(end)
    { NULL, NULL, NULL, NULL }
};
