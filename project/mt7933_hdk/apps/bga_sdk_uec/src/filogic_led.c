...
static filogic_led_color_t  led1_color = FILOGIC_LED_B;
static filogic_led_color_t  led2_color = FILOGIC_LED_G;
static uint8_t              led1_dim = 32;
static uint8_t              led2_dim = 32;
...
{
    led_cmd.led1_r = led_cmd.led1_g = led_cmd.led1_b = 0;
    if (on_off) {
        switch (led1_color) {
            case FILOGIC_LED_R:
                led_cmd.led1_r = led1_dim;
                break;
            case FILOGIC_LED_G:
                led_cmd.led1_g = led1_dim;
                break;
            case FILOGIC_LED_B:
                led_cmd.led1_b = led1_dim;
                break;
            default:
                break;
        }
...
{
    led_cmd.led2_r = led_cmd.led2_g = led_cmd.led2_b = 0;
    if (on_off) {
        switch (led2_color) {
            case FILOGIC_LED_R:
                led_cmd.led2_r = led2_dim;
                break;
            case FILOGIC_LED_G:
                led_cmd.led2_g = led2_dim;
                break;
            case FILOGIC_LED_B:
                led_cmd.led2_b = led2_dim;
                break;
            default:
                break;
        }
