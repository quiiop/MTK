...
#define IS_COMPATIBLE_USBAUDIO_MID(guid)                \
    (((guid)->Data1 >= 0x4e1cecd2) &&               \
     ...
     ((guid)->Data4[6] == 0x6e) &&                  \
     ((guid)->Data4[7] == 0xba) )
#endif /* #ifndef INIT_USBAUDIO_MID */
...
#define IS_COMPATIBLE_USBAUDIO_PID(guid)                \
    (((guid)->Data1 >= 0xabcc5a5e) &&               \
     ...
     ((guid)->Data4[6] == 0x6e) &&                  \
     ((guid)->Data4[7] == 0xba) )
#endif /* #ifndef INIT_USBAUDIO_PID */
...
#endif /* #ifndef INIT_USBAUDIO_PRODUCT_NAME */
...
#include <pshpack1.h>
#endif /* #if !defined(PACK_PRAGMAS_NOT_SUPPORTED) */
typedef struct {
...
#include <poppack.h>
#endif /* #if !defined(PACK_PRAGMAS_NOT_SUPPORTED) */
#endif /* #if defined(_INC_MMSYSTEM) || defined(_INC_MMREG) */
...
#endif /* #ifndef __DDRAW_INCLUDED__ */
...
#endif /* #ifndef __ENCODER_API_GUIDS__ */
...
#endif /* #ifndef __ENCODER_API_DEFINES__ */
