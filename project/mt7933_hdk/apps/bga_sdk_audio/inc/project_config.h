...
#define BT_TX_BUF_SIZE (1024 * 14) // enlarge tx buf to *4 for send tx buffer
#define BT_RX_BUF_SIZE (1024 * 20) // enlarge rx buf to *6 for mesh scan
