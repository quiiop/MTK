...
#define IS_MFG_MAGIC( _v )          ( (DRV_Reg32(_v + 8)&DRV_Reg32(_v + 12)) == MFG_MAGIC )


#ifndef MFG_MAGIC
    #define MFG_MAGIC               0x4D464742 /* MFGB -> BGFM */
#endif


#ifndef BL_SWITCH_GPIO
    #define BL_SWITCH_GPIO          HAL_GPIO_21
#endif


#if defined(MTK_RELEASE_MODE) && defined(MTK_MFG_VERIFY)
    #define MFG_SEC_TYPE            true
    #define MFG_RUN_TYPE            false
#endif


#if !defined(MTK_MFG_BOOT)
bool is_mfg_boot(void);
#endif
