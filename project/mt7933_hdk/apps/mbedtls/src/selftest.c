...
#ifndef MTK_MBEDTLS_VER_3_2_1
#include "mbedtls/arc4.h"
#endif /* #ifndef MTK_MBEDTLS_VER_3_2_1 */
...
int tls_selftest_main(int argc, char *argv[])
{
    ...
    if ((ret = mbedtls_md2_self_test(v)) != 0)
        return (ret);
#endif /* #if defined(MBEDTLS_MD2_C) */

#if defined(MBEDTLS_MD4_C)
    if ((ret = mbedtls_md4_self_test(v)) != 0)
        return (ret);
#endif /* #if defined(MBEDTLS_MD4_C) */

#if defined(MBEDTLS_MD5_C)
    if ((ret = mbedtls_md5_self_test(v)) != 0)
        return (ret);
#endif /* #if defined(MBEDTLS_MD5_C) */
    ...
    if ((ret = mbedtls_sha512_self_test(v)) != 0)
        return (ret);
#endif /* #if defined(MBEDTLS_SHA512_C) */

#ifndef MTK_MBEDTLS_VER_3_2_1
#if defined(MBEDTLS_ARC4_C)
    if ((ret = mbedtls_arc4_self_test(v)) != 0)
        return (ret);
#endif /* #if defined(MBEDTLS_ARC4_C) */
#endif /* #ifndef MTK_MBEDTLS_VER_3_2_1 */
    ...
    if ((ret = mbedtls_gcm_self_test(v)) != 0)
        return (ret);
#endif /* #if defined(MBEDTLS_GCM_C) && defined(MBEDTLS_AES_C) */

#if defined(MBEDTLS_CCM_C) && defined(MBEDTLS_AES_C)
    if ((ret = mbedtls_ccm_self_test(v)) != 0)
        return (ret);
#endif /* #if defined(MBEDTLS_CCM_C) && defined(MBEDTLS_AES_C) */
    ...
    if ((ret = mbedtls_x509_self_test(v)) != 0)
        return (ret);
#endif /* #if defined(MBEDTLS_X509_USE_C) */
...
#else /* #if defined(MBEDTLS_SELF_TEST) */
...
#endif /* #if defined(MBEDTLS_MEMORY_BUFFER_ALLOC_C) && defined(MBEDTLS_MEMORY_DEBUG) */
    }
